		...
		h.setLabel = function(e) {
			...
			setTimeout(
					function() {
						...
						h.right_sdo.setX(h.text_sdo.screen.offsetWidth
								+ h.marginWidth);
						h.totalWidth = h.marginWidth * 2
								+ h.text_sdo.screen.offsetWidth;
						h.positionPointer(0)
					}, 50)
		};
	...
	var e = function(t, n, r, i, s) {
		...
		o.onMouseDown = function(t) {
			...
			if (t.preventDefault)
				t.preventDefault();
			if (!o.isMobile_bl)
				o.onMouseOver(t, false);
			if (o.disptachMainEvent_bl)
				o.dispatchEvent(e.MOUSE_DOWN, {
					e : t
				})
		};
		...
		o.destroy = function() {
			if (o.isMobile_bl) {
				if (o.hasPointerEvent_bl) {
					o.screen
							.removeEventListener("MSPointerDown", o.onMouseDown);
					o.screen.removeEventListener("MSPointerUp", o.onClick);
					o.screen
							.removeEventListener("MSPointerOver", o.onMouseOver);
...
(function(e) {
	var t = function() {
		...
		this.showError = function(e, t, r) {
			var i = n.main_do.getInnerHTML() + "<br>" + "JavaScript error: "
					+ e + " on line " + r + " for " + t;
	...
	var e = function(t, n) {
		...
		r.init = function() {
			if (r.itemsLabels_ar || r.showScriptDeveloper_bl) {
				...
				r.setupSpacers();
				r.getMaxWidthResizeAndPositionId_to = setTimeout(
						r.getMaxWidthResizeAndPosition, 200)
			}
			r.addContextEvent()
		};
		r.setupLabels = function() {
			...
			for (var o = 0; o < e; o++) {
				...
				if (n == "pan") {
					i = r.itemsLabels_ar[o]
							|| "Contextmenu item is not defined!";
					FWDContextMenuButton.setPrototype();
					r.panButton_do = new FWDContextMenuButton(i, undefined,
							r.itemNormalColor_str, r.itemSelectedColor_str,
							r.itemDisabledColor_str);
					r.items_ar.push(r.panButton_do);
					if (r.draggingMode_str == FWDController.PAN)
						r.panButton_do.disable();
					r.panButton_do.addListener(FWDContextMenuButton.MOUSE_DOWN,
							r.panRotateStartHandler);
					r.addChild(r.panButton_do)
				} else if (n == "rotate") {
					i = r.itemsLabels_ar[o]
							|| "Contextmenu item is not defined!";
					FWDContextMenuButton.setPrototype();
					r.rotateButton_do = new FWDContextMenuButton(i, undefined,
							r.itemNormalColor_str, r.itemSelectedColor_str,
							r.itemDisabledColor_str);
					r.items_ar.push(r.rotateButton_do);
					if (r.draggingMode_str == FWDController.ROTATE)
						r.rotateButton_do.disable();
					r.rotateButton_do.addListener(
							FWDContextMenuButton.MOUSE_DOWN,
							r.panButtonStartHandler);
					r.addChild(r.rotateButton_do)
				} else if (n == "rotateright") {
					i = r.itemsLabels_ar[o]
							|| "Contextmenu item is not defined!";
					FWDContextMenuButton.setPrototype();
					r.nextButton_do = new FWDContextMenuButton(i, undefined,
							r.itemNormalColor_str, r.itemSelectedColor_str,
							r.itemDisabledColor_str);
					r.items_ar.push(r.nextButton_do);
					r.nextButton_do.addListener(
							FWDContextMenuButton.MOUSE_DOWN,
							r.nextButtonStartHandler);
					r.addChild(r.nextButton_do)
				} else if (n == "roteteleft") {
					i = r.itemsLabels_ar[o]
							|| "Contextmenu item is not defined!";
					FWDContextMenuButton.setPrototype();
					r.prevButton_do = new FWDContextMenuButton(i, undefined,
							r.itemNormalColor_str, r.itemSelectedColor_str,
							r.itemDisabledColor_str);
					r.items_ar.push(r.prevButton_do);
					r.prevButton_do.addListener(
							FWDContextMenuButton.MOUSE_DOWN,
							r.prevButtonStartHandler);
					...
					FWDContextMenuButton.setPrototype();
					r.zoomInButton_do = new FWDContextMenuButton(i, undefined,
							r.itemNormalColor_str, r.itemSelectedColor_str,
							r.itemDisabledColor_str);
					r.items_ar.push(r.zoomInButton_do);
					r.zoomInButton_do.addListener(
							FWDContextMenuButton.MOUSE_DOWN,
							r.zoomInButtonStartHandler);
					r.addChild(r.zoomInButton_do);
					FWDContextMenuButton.setPrototype();
					r.zoomOutButton_do = new FWDContextMenuButton(s, undefined,
							r.itemNormalColor_str, r.itemSelectedColor_str,
							r.itemDisabledColor_str);
					r.items_ar.push(r.zoomOutButton_do);
					r.zoomOutButton_do.addListener(
							FWDContextMenuButton.MOUSE_DOWN,
							r.zoomOutButtonStartHandler);
					...
					FWDContextMenuButton.setPrototype();
					r.slideShowButton_do = new FWDContextMenuButton(i, s,
							r.itemNormalColor_str, r.itemSelectedColor_str,
							r.itemDisabledColor_str);
					r.items_ar.push(r.slideShowButton_do);
					r.slideShowButton_do.addListener(
							FWDContextMenuButton.MOUSE_DOWN,
							r.startSlideShowHandler);
					r.addChild(r.slideShowButton_do)
				} else if (n == "info") {
					i = r.itemsLabels_ar[o]
							|| "Contextmenu item is not defined!";
					FWDContextMenuButton.setPrototype();
					r.infoButton_do = new FWDContextMenuButton(i, s,
							r.itemNormalColor_str, r.itemSelectedColor_str,
							r.itemDisabledColor_str);
					r.items_ar.push(r.infoButton_do);
					r.infoButton_do.addListener(
							FWDContextMenuButton.MOUSE_DOWN, r.infoButtonStart);
					r.addChild(r.infoButton_do)
				} else if (n == "link") {
					i = r.itemsLabels_ar[o]
							|| "Contextmenu item is not defined!";
					FWDContextMenuButton.setPrototype();
					r.linkButton_do = new FWDContextMenuButton(i, s,
							r.itemNormalColor_str, r.itemSelectedColor_str,
							r.itemDisabledColor_str);
					r.items_ar.push(r.linkButton_do);
					r.linkButton_do.addListener(FWDContextMenuButton.CLICK,
							r.startLinkHandler);
					...
					if (!(t.displayType == FWDViewer.FULL_SCREEN && !FWDUtils.hasFullScreen)) {
						...
						FWDContextMenuButton.setPrototype();
						r.fullScreenButton_do = new FWDContextMenuButton(i, s,
								r.itemNormalColor_str, r.itemSelectedColor_str,
								r.itemDisabledColor_str);
						r.items_ar.push(r.fullScreenButton_do);
						r.fullScreenButton_do.addListener(
								FWDContextMenuButton.MOUSE_DOWN,
								r.fullScreenStartHandler);
		...
		r.setupDeveloperButton = function() {
			if (r.showScriptDeveloper_bl) {
				...
				FWDContextMenuButton.setPrototype();
				r.developerButton_do = new FWDContextMenuButton(label1_str,
						undefined, r.itemSelectedColor_str,
						r.itemNormalColor_str, r.itemDisabledColor_str);
		...
		r.getMaxWidthResizeAndPosition = function() {
			...
			for (var o = 0; o < e; o++) {
				t = r.items_ar[o];
				if (t.getMaxTextWidth() > r.totalWidth)
					r.totalWidth = t.getMaxTextWidth()
			}
			for (var o = 0; o < e; o++) {
				n = r.spacers_ar[o - 1];
				t = r.items_ar[o];
				t.setX(r.padding);
				t.setY(10 + o * (t.totalHeight + r.sapaceBetweenButtons)
						- r.padding);
				if (n) {
		...
		r.addContextEvent = function() {
			if (r.parent.main_do.screen.addEventListener) {
				r.parent.main_do.screen.addEventListener("contextmenu",
						r.contextMenuHandler)
			} else {
				r.parent.main_do.screen.attachEvent("oncontextmenu",
						r.contextMenuHandler)
			}
		};
		r.contextMenuHandler = function(e) {
			...
			if (window.addEventListener) {
				window.addEventListener("mousedown",
						r.contextMenuWindowOnMouseDownHandler);
				window.addEventListener("mouseup",
						r.contextMenuWindowOnMouseDownHandler)
			} else {
				document.documentElement.attachEvent("onmousedown",
						r.contextMenuWindowOnMouseDownHandler);
				document.documentElement.attachEvent("onmouseup",
						r.contextMenuWindowOnMouseDownHandler)
			}
			if (e.preventDefault) {
				e.preventDefault()
		...
		r.contextMenuWindowOnMouseDownHandler = function(e) {
			...
			if (!FWDUtils.hitTest(r.screen, n, i)) {
				if (window.removeEventListener) {
					...
					document.documentElement.detachEvent("onmousedown",
							r.contextMenuWindowOnMouseDownHandler);
		...
		r.positionButtons = function(e) {
			...
			if (u + r.totalWidth > n - 2)
				u = s - r.totalWidth;
			if (u < 0)
				u = parseInt((n - r.totalWidth) / 2);
			if (u < 0)
				u = 0;
			if (a + r.totalHeight > i - 2)
				a = o - r.totalHeight;
			if (a < 0)
				a = parseInt((i - r.totalHeight) / 2);
			if (a < 0)
				a = 0;
			r.setX(u);
			r.setY(a)
		...
		r.disable = function() {
			...
			if (r.slideShowButton_do)
				r.slideShowButton_do.disable();
			if (r.infoButton_do)
				r.infoButton_do.disable();
			if (r.zoomInButton_do)
				r.zoomInButton_do.disable();
			if (r.zoomOutButton_do)
				r.zoomOutButton_do.disable();
			if (r.slideShowButton_do)
				r.slideShowButton_do.disable()
		};
		r.enable = function() {
			if (r.panButton_do && r.draggingMode_str == FWDController.ROTATE)
				r.panButton_do.enable();
			if (r.rotateButton_do && r.draggingMode_str == FWDController.PAN)
				r.rotateButton_do.enable();
			if (r.nextButton_do)
			...
			if (r.slideShowButton_do)
				r.slideShowButton_do.enable();
			if (r.infoButton_do)
				r.infoButton_do.enable();
			if (r.zoomInButton_do)
				r.zoomInButton_do.enable();
			if (r.zoomOutButton_do)
				r.zoomOutButton_do.enable();
			if (r.slideShowButton_do)
				r.slideShowButton_do.enable()
		};
		...
		r.destroy = function() {
			...
			if (window.removeEventListener) {
				...
				window.removeEventListener("mouseup",
						r.contextMenuWindowOnMouseDownHandler);
				r.parent.main_do.screen.removeEventListener("contextmenu",
						r.contextMenuHandler)
			} else {
				document.documentElement.detachEvent("onmousedown",
						r.contextMenuWindowOnMouseDownHandler);
				document.documentElement.detachEvent("onmouseup",
						r.contextMenuWindowOnMouseDownHandler);
				r.parent.main_do.screen.detachEvent("oncontextmenu",
						r.contextMenuHandler)
			}
			s = r.items_ar.length;
			for (var o = 0; o < s; o++) {
	...
	var e = function(t, n, r, i, s, o) {
		...
		u.centerText = function() {
			...
			if (FWDUtils.isIEAndLessThen9) {
				u.text1_sdo.setY(Math.round((u.totalHeight - u.text1_sdo
						.getHeight()) / 2) - 1);
				if (u.showSecondButton_bl)
					u.text2_sdo.setY(Math.round((u.totalHeight - u.text2_sdo
							.getHeight()) / 2) - 1)
			} else {
				u.text1_sdo.setY(Math.round((u.totalHeight - u.text1_sdo
						.getHeight()) / 2));
			...
			if (u.showSecondButton_bl)
				u.text2_sdo.setHeight(u.totalHeight + 2)
		};
		u.getMaxTextWidth = function() {
			var e = u.text1_sdo.getWidth();
			var t = 0;
			if (u.showSecondButton_bl)
				t = u.text2_sdo.getWidth();
			return Math.max(e, t)
		};
		u.disable = function() {
...
(function() {
	var e = function(t, n) {
		...
		this.scrollBarPosition = FWDUtils.indexOfArray(r.buttonsTest_ar,
				"scrollbar");
		...
		if (FWDUtils.indexOfArray(r.buttonsTest_ar, "scrollbar") != -1)
			r.showScrollBar_bl = true;
		...
		r.init = function() {
			...
			if (r.showScrollBar_bl)
				r.setupScrollBar();
			if (r.buttonsTest_ar.length == 0 && !r.showScrollBar_bl)
				r.setVisible(false);
			r.hide();
			r.show();
		...
		r.resizeAndPosition = function() {
			if (n.stageWidth == r.stageWidth && n.stageHeight == r.stageHeight)
				return;
		...
		r.onHiderHide = function() {
			if (FWDUtils.hitTest(r.mainHolder_do.screen, r.hider.globalX,
					r.hider.globalY)) {
				r.hider.reset();
				return
			} else {
			...
			for (var o = 0; o < e; o++) {
				...
				if (t == "pan") {
					if (r.showButtonsLabels_bl)
						i = r.buttonsLabels_ar[o] || "tooltip is not defined!";
					r.setupPanButton(i);
		...
		r.positionButtons = function() {
			...
			if (r.showScrollBar_bl) {
				...
				if (r.scrollBarPosition > t)
					r.scrollBarPosition = t;
				if (r.scrollBarPosition < 0)
					r.scrollBarPosition = 0;
				if (r.curWidth > r.maxWidth)
					r.curWidth = r.maxWidth;
				if (t == 0) {
					r.scrollBarTotalWidth = r.startSpaceBetweenButtons * 2
							+ r.startSpaceForScrollBarButtons * 2
							+ r.smallSpaceForScrollBar * 2 + r.zoomButtonWidth
							* 2
				} else if (t > 1 && r.scrollBarPosition != 0
						&& r.scrollBarPosition != t) {
					r.scrollBarTotalWidth = r.startSpaceBetweenButtons * 2 + t
							* r.buttonWidth + r.spaceBetweenButtons * (t - 2)
							+ r.startSpaceForScrollBarButtons * 2
							+ r.smallSpaceForScrollBar * 2 + r.zoomButtonWidth
							* 2
				} else if (t > 1
						&& (r.scrollBarPosition == 0 || r.scrollBarPosition == t)) {
					r.scrollBarTotalWidth = r.startSpaceBetweenButtons * 3 + t
							* r.buttonWidth + r.spaceBetweenButtons * (t - 1)
							+ r.startSpaceForScrollBarButtons * 2
							+ r.smallSpaceForScrollBar * 2 + r.zoomButtonWidth
							* 2
				} else {
					r.scrollBarTotalWidth = r.startSpaceBetweenButtons * 2 + t
							* r.buttonWidth + r.startSpaceForScrollBarButtons
							* 2 + r.smallSpaceForScrollBar * 2
							+ r.zoomButtonWidth * 2
				}
				r.scrollBarTotalWidth = r.curWidth - r.scrollBarTotalWidth;
				if (r.scrollBarTotalWidth < 100)
					r.isScrollBarActive_bl = false
			}
			if (r.isScrollBarActive_bl) {
				...
				for (var h = 0; h < r.scrollBarPosition; h++) {
					...
					if (l) {
						l = r.buttons_ar[h];
						a = r.startSpaceBetweenButtons + h
								* (n + r.buttonWidth);
						a = r.startSpaceBetweenButtons + h
								* (n + r.buttonWidth);
				...
				for (var h = t + 1; h >= r.scrollBarPosition; h--) {
					...
					if (l) {
						l = r.buttons_ar[h];
						a = r.curWidth - r.startSpaceBetweenButtons
								- r.buttonWidth - Math.abs(h - t + 1)
								* (n + r.buttonWidth);
						f = parseInt((r.curHeight - r.buttonHeight) / 2);
						l.setX(a);
						l.setY(f)
				...
				if (t == 0) {
					u = r.startSpaceForScrollBarButtons
							+ r.startSpaceBetweenButtons
				} else if (t > 1 && r.scrollBarPosition != 0
						&& r.scrollBarPosition != t) {
					u = r.buttons_ar[r.scrollBarPosition - 1].getX()
							+ r.buttonWidth + r.startSpaceForScrollBarButtons
				} else if (t > 1 && r.scrollBarPosition == 0) {
					u = r.startSpaceBetweenButtons
							+ r.startSpaceForScrollBarButtons
				} else if (t > 1 && r.scrollBarPosition == t) {
					u = r.buttons_ar[r.scrollBarPosition - 1].getX()
							+ r.buttonWidth + r.startSpaceForScrollBarButtons
							+ r.startSpaceBetweenButtons
				} else if (t == 1 && r.scrollBarPosition > 0) {
					u = r.startSpaceBetweenButtons + r.buttonWidth
							+ r.startSpaceForScrollBarButtons
				} else if (t == 1 && r.scrollBarPosition == 0) {
					u = r.startSpaceForScrollBarButtons
							+ r.startSpaceBetweenButtons
				...
				r.zoomOut_do.setX(u);
				r.zoomOut_do
						.setY(parseInt((r.curHeight - r.zoomButtonHeight) / 2));
				r.zoomIn_do.setX(r.zoomOut_do.getX() + r.zoomButtonWidth
						+ r.smallSpaceForScrollBar * 2 + r.scrollBarTotalWidth);
				r.zoomIn_do
						.setY(parseInt((r.curHeight - r.zoomButtonHeight) / 2));
				r.scrollBar_do.setX(r.zoomOut_do.getX()
						+ r.smallSpaceForScrollBar + r.zoomButtonWidth);
				r.scrollBar_do
						.setY(parseInt((r.curHeight - r.scrollBarHeight) / 2) + 1);
				r.scrollBar_do.setWidth(r.scrollBarTotalWidth);
				r.scrollBarMiddle_do.setX(r.scrollBarRightPartWidth - 1);
				r.scrollBarMiddle_do.setWidth(r.scrollBarTotalWidth
						- r.scrollBarRightPartWidth * 2 + 2);
				r.scrollBarRight_do.setX(r.scrollBarTotalWidth
						- r.scrollBarRightPartWidth)
			} else {
				if (r.showScrollBar_bl) {
				...
				r.minWidth = t * r.buttonWidth + r.startSpaceBetweenButtons * 2
						+ r.spaceBetweenButtons * t - r.spaceBetweenButtons;
				...
				for (var h = 0; h < t + 2; h++) {
					...
					if (l) {
						...
						if (l == r.zoomIn_do) {
							a = a
									+ parseInt((r.buttonWidth - r.zoomButtonWidth) / 2)
									- 2;
			...
			r.backgroundRight_sdo.setX(r.curWidth
					- r.backgroundRight_sdo.getWidth());
			r.backgroundMiddle_sdo.setX(r.backgroundLeft_sdo.getWidth());
			r.backgroundMiddle_sdo.setWidth(r.curWidth
					- r.backgroundLeft_sdo.getWidth() * 2);
			...
			if (r.controllerPosition_str == e.POSITION_TOP) {
				r.mainHolder_do.setX(Math
						.round((r.stageWidth - r.curWidth) / 2));
		...
		r.setupBackground = function() {
			...
			if (r.controllerBackgroundOpacity != 1)
				r.backgroundLeft_sdo.setAlpha(r.controllerBackgroundOpacity);
			r.backgroundMiddle_sdo = new FWDSimpleDisplayObject("div");
			r.backgroundMiddle_sdo.getStyle().background = "url('"
					+ r.backgroundMiddlePath_str + "')";
			r.backgroundMiddle_sdo.getStyle().backgroundRepeat = "repeat-x";
			if (r.controllerBackgroundOpacity != 1)
				r.backgroundMiddle_sdo.setAlpha(r.controllerBackgroundOpacity);
			r.backgroundRight_sdo = new FWDSimpleDisplayObject("img");
			r.backgroundRight_sdo.setScreen(r.backgroundRight_img);
			if (r.controllerBackgroundOpacity != 1)
				r.backgroundRight_sdo.setAlpha(r.controllerBackgroundOpacity);
		...
		r.setupPanButton = function(t) {
			...
			r.panButton_do = new FWDSimpleButton(r.panN_img, r.panS_img,
					r.isMobile_bl);
			r.panButton_do.addListener(FWDSimpleButton.MOUSE_OVER,
					r.panButtonOnMouseOverHandler);
			r.panButton_do.addListener(FWDSimpleButton.MOUSE_OUT,
					r.panButtonOnMouseOutHandler);
			r.panButton_do.addListener(FWDSimpleButton.MOUSE_DOWN,
					r.panButtonOnMouseDownHandler);
			r.mainHolder_do.addChild(r.panButton_do);
			if (r.draggingMode_str == e.PAN)
				r.disablePanButton();
			if (r.showButtonsLabels_bl) {
				FWDButtonToolTip.setPrototype();
				r.panButtonTooTipLabel_do = new FWDButtonToolTip(
						r.toolTipLeft_img, r.toolTipPointer_img, t, "",
						r.buttonToolTipLeft_str, r.buttonToolTipMiddle_str,
						r.buttonToolTipRight_str, r.buttonToolTipFontColor_str,
						r.controllerPosition_str,
						r.buttonToolTipTopPointer_str,
						r.buttonToolTipBottomPointer_str);
				r.mainHolder_do.addChild(r.panButtonTooTipLabel_do)
			}
		};
		r.panButtonOnMouseOverHandler = function(e) {
			if (r.panButton_do.isSelectedFinal_bl)
				return;
			r.showToolTipButton(r.panButton_do, r.panButtonTooTipLabel_do,
					r.buttonsToolTipOffsetY)
		};
		r.panButtonOnMouseOutHandler = function(e) {
			if (r.showButtonsLabels_bl)
				r.panButtonTooTipLabel_do.hide()
		};
		...
		r.disablePanButton = function() {
			...
			if (r.rotateButton_do)
				r.rotateButton_do.setUnselctedFinal()
		};
		this.pan = function() {
			if (r.slideShowButton_do)
				r.stopSlideShow();
		...
		r.setupRotateButton = function(t) {
			FWDSimpleButton.setPrototype();
			r.rotateButton_do = new FWDSimpleButton(r.rotateN_img,
					r.rotateS_img, r.isMobile_bl);
			r.rotateButton_do.addListener(FWDSimpleButton.MOUSE_OVER,
					r.rotateButtonOnMouseOverHandler);
			r.rotateButton_do.addListener(FWDSimpleButton.MOUSE_OUT,
					r.rotateButtonOnMouseOutHandler);
			r.rotateButton_do.addListener(FWDSimpleButton.MOUSE_DOWN,
					r.rotateButtonOnMouseDownHandler);
			r.mainHolder_do.addChild(r.rotateButton_do);
			if (r.draggingMode_str == e.ROTATE)
				r.disableRotateButton();
			if (r.showButtonsLabels_bl) {
				FWDButtonToolTip.setPrototype();
				r.rotateButtonToolTip_do = new FWDButtonToolTip(
						r.toolTipLeft_img, r.toolTipPointer_img, t, "",
						r.buttonToolTipLeft_str, r.buttonToolTipMiddle_str,
						r.buttonToolTipRight_str, r.buttonToolTipFontColor_str,
						r.controllerPosition_str,
		...
		r.rotateButtonOnMouseOverHandler = function(e) {
			if (r.rotateButton_do.isSelectedFinal_bl)
				return;
			r.showToolTipButton(r.rotateButton_do, r.rotateButtonToolTip_do,
					r.buttonsToolTipOffsetY)
		};
		r.rotateButtonOnMouseOutHandler = function(e) {
			if (r.showButtonsLabels_bl)
				r.rotateButtonToolTip_do.hide()
		};
		...
		r.disableRotateButton = function() {
			...
			if (r.panButton_do)
				r.panButton_do.setUnselctedFinal()
		};
		...
		r.setupNextButton = function(e) {
			FWDSimpleButton.setPrototype();
			r.nextButton_do = new FWDSimpleButton(r.nextN_img, r.nextS_img,
					r.isMobile_bl);
			r.nextButton_do.addListener(FWDSimpleButton.MOUSE_OVER,
					r.nextButtonOnMouseOverHandler);
			r.nextButton_do.addListener(FWDSimpleButton.MOUSE_OUT,
					r.nextButtonOnMouseOutHandler);
			r.nextButton_do.addListener(FWDSimpleButton.MOUSE_DOWN,
					r.nextButtonStartHandler);
			r.mainHolder_do.addChild(r.nextButton_do);
			if (r.showButtonsLabels_bl) {
				FWDButtonToolTip.setPrototype();
				r.nextButtonToolTip_do = new FWDButtonToolTip(
						r.toolTipLeft_img, r.toolTipPointer_img, e, "",
						r.buttonToolTipLeft_str, r.buttonToolTipMiddle_str,
						r.buttonToolTipRight_str, r.buttonToolTipFontColor_str,
						r.controllerPosition_str,
						r.buttonToolTipTopPointer_str,
		...
		r.nextButtonOnMouseOverHandler = function(e) {
			if (r.showButtonsLabels_bl)
				r.showToolTipButton(r.nextButton_do, r.nextButtonToolTip_do,
						r.buttonsToolTipOffsetY)
		};
		r.nextButtonOnMouseOutHandler = function(e) {
			if (r.showButtonsLabels_bl)
				r.nextButtonToolTip_do.hide()
		};
		...
		r.gotoNextImage = function() {
			var t = 1;
			if (r.inverseNextAndPrevRotation_bl)
				t = -1;
		...
		r.setupPrevButton = function(e) {
			FWDSimpleButton.setPrototype();
			r.prevButton_do = new FWDSimpleButton(r.prevN_img, r.prevS_img,
					r.isMobile_bl);
			r.prevButton_do.addListener(FWDComplexButton.MOUSE_OVER,
					r.prevButtonOnMouseOverHandler);
			r.prevButton_do.addListener(FWDComplexButton.MOUSE_OUT,
					r.prevShowButtonOnMouseOutHandler);
			r.prevButton_do.addListener(FWDSimpleButton.MOUSE_DOWN,
					r.prevButtonStartHandler);
			r.mainHolder_do.addChild(r.prevButton_do);
			if (r.showButtonsLabels_bl) {
				FWDButtonToolTip.setPrototype();
				r.prevButtonToolTip_do = new FWDButtonToolTip(
						r.toolTipLeft_img, r.toolTipPointer_img, e, "",
						r.buttonToolTipLeft_str, r.buttonToolTipMiddle_str,
						r.buttonToolTipRight_str, r.buttonToolTipFontColor_str,
						r.controllerPosition_str,
		...
		r.prevButtonOnMouseOverHandler = function(e) {
			if (r.showButtonsLabels_bl)
				r.showToolTipButton(r.prevButton_do, r.prevButtonToolTip_do,
						r.buttonsToolTipOffsetY)
		};
		r.prevShowButtonOnMouseOutHandler = function(e) {
			if (r.showButtonsLabels_bl)
				r.prevButtonToolTip_do.hide()
		};
		...
		r.setupSlideshowButton = function(e, t) {
			...
			r.slideShowButton_do = new FWDComplexButton(r.playN_img,
					r.playS_img, r.pauseN_img, r.pauseS_img, true);
			r.slideShowButton_do.addListener(FWDComplexButton.MOUSE_OVER,
					r.slideSwhoButtonOnMouseOverHandler);
			r.slideShowButton_do.addListener(FWDComplexButton.MOUSE_OUT,
					r.slideShowButtonOnMouseOutHandler);
			r.slideShowButton_do.addListener(FWDComplexButton.MOUSE_DOWN,
					r.slideShowButtonStartHandler);
			r.mainHolder_do.addChild(r.slideShowButton_do);
			if (r.showButtonsLabels_bl) {
				FWDButtonToolTip.setPrototype();
				r.slideShowToolTip_do = new FWDButtonToolTip(r.toolTipLeft_img,
						r.toolTipPointer_img, e, t, r.buttonToolTipLeft_str,
						r.buttonToolTipMiddle_str, r.buttonToolTipRight_str,
						r.buttonToolTipFontColor_str, r.controllerPosition_str,
						r.buttonToolTipTopPointer_str,
						r.buttonToolTipBottomPointer_str);
		...
		r.slideSwhoButtonOnMouseOverHandler = function(e) {
			if (r.showButtonsLabels_bl)
				r.showToolTipButton(r.slideShowButton_do,
						r.slideShowToolTip_do, r.buttonsToolTipOffsetY)
		};
		r.slideShowButtonOnMouseOutHandler = function(e) {
			if (r.showButtonsLabels_bl)
				r.slideShowToolTip_do.hide()
		};
			...
			if (r.slideShowButton_do.currentState == 1) {
				...
				if (r.showButtonsLabels_bl)
					r.slideShowToolTip_do
							.setLabel(r.slideShowToolTip_do.toolTipLabel2_str)
			} else {
				r.stopSlideShow();
				r.slideShowButton_do.setButtonState(1);
				if (r.showButtonsLabels_bl)
					r.slideShowToolTip_do
							.setLabel(r.slideShowToolTip_do.toolTipLabel_str)
			}
		};
		r.startSlideshow = function() {
			...
			r.slideShowId_int = setInterval(r.slideShowComplete,
					r.slideShowDelay);
		...
		r.setupInfoButton = function(e) {
			FWDSimpleButton.setPrototype();
			r.infoButton_do = new FWDSimpleButton(r.infoN_img, r.infoS_img,
					r.isMobile_bl);
			r.infoButton_do.addListener(FWDComplexButton.MOUSE_OVER,
					r.infoButtonOnMouseOverHandler);
			r.infoButton_do.addListener(FWDComplexButton.MOUSE_OUT,
					r.infoButtonOnMouseOutHandler);
			r.infoButton_do.addListener(FWDComplexButton.MOUSE_DOWN,
					r.infoButtonStartHandler);
			r.mainHolder_do.addChild(r.infoButton_do);
			if (r.showButtonsLabels_bl) {
				FWDButtonToolTip.setPrototype();
				r.infoToolTip_do = new FWDButtonToolTip(r.toolTipLeft_img,
						r.toolTipPointer_img, e, "", r.buttonToolTipLeft_str,
						r.buttonToolTipMiddle_str, r.buttonToolTipRight_str,
						r.buttonToolTipFontColor_str, r.controllerPosition_str,
						r.buttonToolTipTopPointer_str,
						r.buttonToolTipBottomPointer_str);
		...
		r.infoButtonOnMouseOverHandler = function(e) {
			if (r.showButtonsLabels_bl)
				r.showToolTipButton(r.infoButton_do, r.infoToolTip_do,
						r.buttonsToolTipOffsetY)
		};
		r.infoButtonOnMouseOutHandler = function(e) {
			if (r.showButtonsLabels_bl)
				r.infoToolTip_do.hide()
		};
		...
		r.setupLinkButton = function(e) {
			FWDSimpleButton.setPrototype();
			r.linkButton_do = new FWDSimpleButton(r.linkN_img, r.linkS_img,
					r.isMobile_bl);
			r.linkButton_do.addListener(FWDComplexButton.MOUSE_OVER,
					r.linkButtonOnMouseOverHandler);
			r.linkButton_do.addListener(FWDComplexButton.MOUSE_OUT,
					r.linkButtonOnMouseOutHandler);
			r.linkButton_do.addListener(FWDComplexButton.CLICK,
					r.linkButtonOnMouseClickHandler);
			r.mainHolder_do.addChild(r.linkButton_do);
			if (r.showButtonsLabels_bl) {
				FWDButtonToolTip.setPrototype();
				r.linkToolTip_do = new FWDButtonToolTip(r.toolTipLeft_img,
						r.toolTipPointer_img, e, "", r.buttonToolTipLeft_str,
						r.buttonToolTipMiddle_str, r.buttonToolTipRight_str,
						r.buttonToolTipFontColor_str, r.controllerPosition_str,
						r.buttonToolTipTopPointer_str,
		...
		r.linkButtonOnMouseOverHandler = function(e) {
			if (r.showButtonsLabels_bl)
				r.showToolTipButton(r.linkButton_do, r.linkToolTip_do,
						r.buttonsToolTipOffsetY)
		};
		r.linkButtonOnMouseOutHandler = function(e) {
			if (r.showButtonsLabels_bl)
				r.linkToolTip_do.hide()
		};
		...
		r.setupFullScreenButton = function(e, t) {
			FWDComplexButton.setPrototype();
			r.fullScreenButton_do = new FWDComplexButton(r.fullScreenFullN_img,
					r.fullScreenFullS_img, r.fullScreenNormalN_img,
					r.fullScreenNormalS_img, true);
			r.fullScreenButton_do.addListener(FWDComplexButton.MOUSE_OVER,
					r.fullscreenButtonOnMouseOverHandler);
			r.fullScreenButton_do.addListener(FWDComplexButton.MOUSE_OUT,
					r.fullscreenButtonOnMouseOutHandler);
			r.fullScreenButton_do.addListener(FWDComplexButton.MOUSE_DOWN,
					r.fullScreenButtonStartHandler);
			r.mainHolder_do.addChild(r.fullScreenButton_do);
			if (r.showButtonsLabels_bl) {
				FWDButtonToolTip.setPrototype();
				r.fullscreenToolTip_do = new FWDButtonToolTip(
						r.toolTipLeft_img, r.toolTipPointer_img, e, t,
						r.buttonToolTipLeft_str, r.buttonToolTipMiddle_str,
						r.buttonToolTipRight_str, r.buttonToolTipFontColor_str,
						r.controllerPosition_str,
						r.buttonToolTipTopPointer_str,
		...
		this.onFullScreenChange = function(t) {
			...
			if (document.fullScreen || document.mozFullScreen
					|| document.webkitIsFullScreen || document.msieFullScreen) {
				if (r.showButtonsLabels_bl)
					r.fullscreenToolTip_do
							.setLabel(r.fullscreenToolTip_do.toolTipLabel2_str);
				r.fullScreenButton_do.setButtonState(0);
		...
		r.setupScrollBar = function() {
			...
			r.zoomIn_do.addListener(FWDSimpleButton.MOUSE_OVER,
					r.zoomInMouseOverHandler);
			r.zoomIn_do.addListener(FWDSimpleButton.MOUSE_OUT,
					r.zoomInOrOutMouseOutHandler);
			r.zoomIn_do.addListener(FWDSimpleButton.MOUSE_DOWN,
					r.zoomInStartHandler);
			r.mainHolder_do.addChild(r.zoomIn_do);
			FWDSimpleButton.setPrototype();
			r.zoomOut_do = new FWDSimpleButton(r.zoomOutN_img, r.zoomOutS_img);
			r.zoomOut_do.addListener(FWDSimpleButton.MOUSE_OVER,
					r.zoomOutMouseOverHandler);
			r.zoomOut_do.addListener(FWDSimpleButton.MOUSE_OUT,
					r.zoomInOrOutMouseOutHandler);
			r.zoomOut_do.addListener(FWDSimpleButton.MOUSE_DOWN,
					r.zoomOutStartHandler);
			...
			r.scrollBarMiddle_do.getStyle().background = "url('"
					+ r.scrollBarMiddlePath_str + "')";
			...
			FWDSimpleButton.setPrototype();
			r.scrollBarHandler_do = new FWDSimpleButton(
					r.scrollBarHandlerN_img, r.scrollBarHandlerS_img,
					r.isMobile_bl);
			r.scrollBarHandler_do
					.setY(parseInt((r.scrollBarHeight - r.scrollBarHandlerHeight) / 2) - 1);
			r.scrollBarHandler_do.addListener(FWDSimpleButton.MOUSE_OVER,
					r.handlerOnMouseOver);
			r.scrollBarHandler_do.addListener(FWDSimpleButton.MOUSE_OUT,
					r.handlerOnMouseOut);
			r.scrollBarHandler_do.addListener(FWDSimpleButton.MOUSE_DOWN,
					r.handlerDragStartHandler);
			r.scrollBar_do.addChild(r.scrollBarHandler_do);
			if (r.showButtonsLabels_bl) {
				e = r.buttonsLabels_ar[r.scrollBarPosition]
						|| "tooltip is not defined!";
				FWDButtonToolTip.setPrototype();
				r.scrollBarHandlerToolTip_do = new FWDButtonToolTip(
						r.toolTipLeft_img, r.toolTipPointer_img, e, "",
						r.buttonToolTipLeft_str, r.buttonToolTipMiddle_str,
						r.buttonToolTipRight_str, r.buttonToolTipFontColor_str,
						r.controllerPosition_str,
					...
					if (!r.isScrollBarActive_bl && r.showButtonsLabels_bl) {
						setTimeout(
								function() {
									...
									r.scrollBarHandlerToolTip_do
											.setLabel(r.scrollBarHandlerToolTip_do.toolTipLabel_str
													+ Math.round(e * 100) + "%");
									r.showZoomInOrOutToolTipButton(r.zoomIn_do,
											r.scrollBarHandlerToolTip_do,
											r.zoomInAndOutToolTipOffsetY)
								}, 50)
					}
				}
			}
		...
		r.zoomInOrOutMouseOutHandler = function(e) {
			if (r.showButtonsLabels_bl)
				r.scrollBarHandlerToolTip_do.hide()
		};
		...
		r.startZoomInWithDelay = function() {
			r.zoomWithButtonsId_int = setInterval(
					r.zoomInWithButtonsDispatchEvent, 16)
		};
			...
			if (!r.isScrollBarActive_bl && r.showButtonsLabels_bl) {
				setTimeout(
						function() {
							if (r == null)
								return;
							var e = r.finalHandlerX
									/ (r.scrollBarTotalWidth - r.scrollBarHandlerWidth);
							if (r.scrollBarHandlerToolTip_do)
								r.scrollBarHandlerToolTip_do
										.setLabel(r.scrollBarHandlerToolTip_do.toolTipLabel_str
												+ Math.round(e * 100) + "%");
							if (r.showZoomInOrOutToolTipButton)
								r.showZoomInOrOutToolTipButton(r.zoomIn_do,
										r.scrollBarHandlerToolTip_do,
										r.zoomInAndOutToolTipOffsetY)
						}, 50)
						...
						setTimeout(
								function() {
									...
									r.scrollBarHandlerToolTip_do
											.setLabel(r.scrollBarHandlerToolTip_do.toolTipLabel_str
													+ Math.round(e * 100) + "%");
									r.showZoomInOrOutToolTipButton(
											r.zoomOut_do,
											r.scrollBarHandlerToolTip_do,
											r.zoomInAndOutToolTipOffsetY)
								}, 50)
		...
		r.zoomOutStartHandler = function(t) {
			...
			if (r.isMobile_bl) {
				if (r.hasPointerEvent_bl) {
					window.addEventListener("MSPointerUp",
							r.zoomOutWithButtonsEndHandler)
				} else {
					window.addEventListener("touchend",
							r.zoomOutWithButtonsEndHandler)
				}
		...
		r.startZoomOutWithDelay = function() {
			r.zoomWithButtonsId_int = setInterval(
					r.zoomOutWithButtonsDispatchEvent, 16)
		};
							...
							if (r.scrollBarHandlerToolTip_do)
								r.scrollBarHandlerToolTip_do
										.setLabel(r.scrollBarHandlerToolTip_do.toolTipLabel_str
												+ Math.round(e * 100) + "%");
							if (r.showZoomInOrOutToolTipButton)
								r.showZoomInOrOutToolTipButton(r.zoomOut_do,
										r.scrollBarHandlerToolTip_do,
										r.zoomInAndOutToolTipOffsetY)
						}, 50)
			}
		...
		r.zoomOutWithButtonsEndHandler = function(t) {
			...
			if (r.zoomOut_do) {
				...
				n = FWDUtils.getViewportMouseCoordinates(t);
				if (!FWDUtils
						.hitTest(r.zoomOut_do.screen, n.screenX, n.screenY)) {
		...
		r.handlerDragStartHandler = function(t) {
			...
			if (r.isMobile_bl) {
				r.handlerDragEndHandler(t);
				if (r.prevButton_do || r.prevButton_do)
					r.gotoImageEndHandler(t)
			}
			if (r.slideShowButton_do)
				r.stopSlideShow();
		...
		r.handlerDragMoveHandler = function(t) {
			if (t.preventDefault)
				t.preventDefault();
			var n = FWDUtils.getViewportMouseCoordinates(t);
			r.finalHandlerX = Math.round(r.scrollBarHandlerXPositionOnPress
					+ n.screenX - r.lastPresedX);
			if (r.finalHandlerX <= 0) {
				r.finalHandlerX = 0
			} else if (r.finalHandlerX >= r.scrollBarTotalWidth
					- r.scrollBarHandlerWidth) {
				r.finalHandlerX = r.scrollBarTotalWidth
						- r.scrollBarHandlerWidth
			}
		...
		r.handlerDragEndHandler = function(t) {
			...
			r.dispatchEvent(e.ENABLE_PAN_OR_MOVE);
			n = FWDUtils.getViewportMouseCoordinates(t);
			if (!FWDUtils.hitTest(r.scrollBarHandler_do.screen, n.screenX,
					n.screenY)) {
		...
		r.positionAndSetLabelScrollBarHandler = function() {
			if (!r.showButtonsLabels_bl || !r.isScrollBarActive_bl)
				return;
			var t = 0;
			var n = 0;
			var i = r.finalHandlerX	/ (r.scrollBarTotalWidth - r.scrollBarHandlerWidth);
			...
			setTimeout(
					function() {
						if (r == null
								|| !r.scrollBarHandlerToolTip_do.isShowed_bl)
							return;
						t = parseInt(r.scrollBarHandler_do.getX()
								+ r.scrollBar_do.getX()
								+ (r.scrollBarHandlerWidth - r.scrollBarHandlerToolTip_do.totalWidth) / 2);
						if (r.controllerPosition_str == e.POSITION_BOTTOM) {
							n = -r.scrollBarHandlerToolTip_do.totalHeight
									- r.scrollBarHandlerToolTipOffsetY
						} else {
		...
		r.showToolTipButton = function(t, n, i) {
			if (r.showButtonsLabels_bl) {
				...
				setTimeout(
						function() {
							if (r == null || !n.isShowed_bl)
								return;
							s = parseInt(t.getX()
									+ (r.buttonWidth - n.totalWidth) / 2);
							if (r.controllerPosition_str == e.POSITION_BOTTOM) {
								o = -n.totalHeight - i
							} else {
								o = r.curHeight + i
		...
		r.cleanMainEvents = function() {
			...
			if (r.isMobile_bl) {
				...
				window
						.removeEventListener("MSPointerUp",
								r.gotoImageEndHandler);
				window.removeEventListener("touchend",
						r.zoomInWithButtonsEndHandler);
				window.removeEventListener("MSPointerUp",
		...
		this.destroy = function() {
			...
			if (r.panButton_do)
				r.panButton_do.destroy();
			if (r.rotateButton_do)
				r.rotateButton_do.destroy();
			if (r.nextButton_do)
				r.nextButton_do.destroy();
			if (r.prevButton_do)
				r.prevButton_do.destroy();
			if (r.slideShowButton_do)
				r.slideShowButton_do.destroy();
			if (r.infoButton_do)
				r.infoButton_do.destroy();
			if (r.linkButton_do)
				r.linkButton_do.destroy();
			if (r.fullScreenButton_do)
				r.fullScreenButton_do.destroy();
			if (r.zoomIn_do)
				r.zoomIn_do.destroy();
			if (r.zoomOut_do)
				r.zoomOut_do.destroy();
			if (r.scrollBar_do)
				r.scrollBar_do.destroy();
			if (r.scrollBarLeft_sdo)
				r.scrollBarLeft_sdo.destroy();
			if (r.scrollBarRight_sdo)
				r.scrollBarRight_sdo.destroy();
			if (r.scrollBarMiddle_sdo)
				r.scrollBarMiddle_sdo.destroy();
			if (r.scrollBarHandler_do) {
				TweenMax.killTweensOf(r.mainHolder_do);
				r.scrollBarHandler_do.destroy()
			}
			if (r.scrollBarHandlerN_sdo)
				r.scrollBarHandlerN_sdo.destroy();
			if (r.scrollBarHandlerS_sdo)
				r.scrollBarHandlerS_sdo.destroy();
			if (r.panButtonTooTipLabel_do)
				r.panButtonTooTipLabel_do.destroy();
			if (r.scrollBarHandlerToolTip_do)
				r.scrollBarHandlerToolTip_do.destroy();
			if (r.rotateButtonToolTip_do)
				r.rotateButtonToolTip_do.destroy();
			if (r.nextButtonToolTip_do)
				r.nextButtonToolTip_do.destroy();
			if (r.prevButtonToolTip_do)
				r.prevButtonToolTip_do.destroy();
			if (r.slideShowToolTip_do)
				r.slideShowToolTip_do.destroy();
			if (r.infoToolTip_do)
				r.infoToolTip_do.destroy();
			if (r.linkToolTip_do)
				r.linkToolTip_do.destroy();
			if (r.fullscreenToolTip_do)
				r.fullscreenToolTip_do.destroy();
			r.buttonsTest_ar = null;
			r.buttons_ar = null;
			r.hider = null;
...
(function(e) {
	var t = function(e) {
		...
		n.parseProperties = function() {
			...
			n.rootElement_el = FWDUtils
					.getChildById(n.props_obj.playListAndSkinId);
			if (!n.rootElement_el) {
				a = "Make sure that the a div with the id - <font color='#FFFFFF'>"
						+ n.props_obj.playListAndSkinId
						+ "</font> exists, self represents the data playlist.";
				n.dispatchEvent(t.LOAD_ERROR, {
					text : a
				});
				return
			...
			e = FWDUtils.getChildFromNodeListFromAttribute(n.rootElement_el,
					"data-skin");
			r = FWDUtils.getChildFromNodeListFromAttribute(n.rootElement_el,
					"data-markers");
			i = FWDUtils.getChildFromNodeListFromAttribute(n.rootElement_el,
					"data-paylist");
			if (!e) {
			...
			if (n.showMarkers_bl) {
				...
				for (var b = 0; b < u.length; b++) {
					...
					g = FWDUtils.hasAttribute(p,
							"data-marker-normal-state-path", b);
					if (!g) {
						n.showMarkerError("data-marker-normal-state-path", b);
						return
					}
					g = FWDUtils.hasAttribute(p,
							"data-marker-selected-state-path", b);
					if (!g) {
					...
					l = c.type == "link" || c.type == "tooltip"
							|| c.type == "infowindow";
					if (!l) {
						n.showMarkerTypeError(c.type, b);
						return
					}
					c.markerId = FWDUtils.trim(FWDUtils.getAttributeValue(p,
							"data-marker-id"));
					c.normalStatePath_str = FWDUtils.trim(FWDUtils
							.getAttributeValue(p,
									"data-marker-normal-state-path"));
					c.selectedStatePath_str = FWDUtils.trim(FWDUtils
							.getAttributeValue(p,
									"data-marker-selected-state-path"));
					c.toolTipLabel = FWDUtils.getAttributeValue(p,
							"data-tool-tip-label")
							|| undefined;
					c.markerWidth = parseInt(FWDUtils.getAttributeValue(p,
							"data-marker-width"));
					if (isNaN(c.markerWidth))
						c.markerWidth = 5;
					c.markerHeight = parseInt(FWDUtils.getAttributeValue(p,
							"data-marker-height"));
					if (isNaN(c.markerHeight))
						c.markerHeight = 5;
					if (c.type == "link") {
						c.link = FWDUtils.getAttributeValue(p,
								"data-marker-url")
								|| "http://www.link-is-not-defined.com";
						c.target = FWDUtils.getAttributeValue(p,
								"data-marker-target")
								|| "_blank"
					} else {
					...
					if (!l) {
						...
						l = FWDUtils
								.trim(
										FWDUtils.getAttributeValue(p,
												"data-reg-point"))
								.toLowerCase()
					}
					c.regPoint = l;
					c.maxWidth = parseInt(FWDUtils.getAttributeValue(p,
							"data-marker-window-width"));
					if (isNaN(c.maxWidth))
						c.maxWidth = 200;
			...
			n.showLargeImageVersionOnZoom_bl = n.showLargeImageVersionOnZoom_bl == "yes" ? true
					: false;
			n.showNavigator_bl = n.props_obj.showNavigator;
			n.showNavigator_bl = n.showNavigator_bl == "yes" ? true : false;
			n.showMarkersInfo_bl = n.props_obj.showMarkersInfo == "yes" ? true
					: false;
			n.addKeyboardSupport_bl = n.props_obj.addKeyboardSupport == "no" ? false
					: true;
			n.stopRotationAtEnds_bl = n.props_obj.stopRotationAtEnds == "yes" ? true
					: false;
			n.addDragAndSpinSupport_bl = n.props_obj.addDragAndSpinSupport == "yes" ? true
					: false;
			if (n.stopRotationAtEnds_bl)
				n.addDragAndSpinSupport_bl = false;
			n.slideShowAutoPlay_bl = n.props_obj.slideShowAutoPlay == "yes" ? true
					: false;
			if (n.isMobile_bl)
				n.showMarkersInfo_bl = false;
			...
			for (var b = 0; b < o.length; b++) {
				...
				for (var E = 0; E < s.length; E++) {
					if (FWDUtils.hasAttribute(s[E], "data-small-image-path")) {
						c.smallImagePath = FWDUtils.trim(FWDUtils
								.getAttributeValue(s[E],
										"data-small-image-path"))
					}
					if (FWDUtils.hasAttribute(s[E], "data-large-image-path")) {
						c.largeImagePath = FWDUtils.trim(FWDUtils
								.getAttributeValue(s[E],
										"data-large-image-path"))
					}
					if (n.showNavigator_bl) {
						if (FWDUtils.hasAttribute(s[E],
								"data-navigator-image-path")) {
							c.navigatorImagePath = FWDUtils.trim(FWDUtils
									.getAttributeValue(s[E],
											"data-navigator-image-path"))
						}
					}
					if (FWDUtils.getAttributeValue(s[E], "data-marker-id")) {
						...
						if (!w)
							w = [];
						h = {};
						h.markerId = FWDUtils.trim(FWDUtils.getAttributeValue(
								s[E], "data-marker-id"));
			...
			n.startAtImage = l;
			n.backgroundColor_str = n.props_obj.backgroundColor
					|| "transparent";
			n.preloaderFontColor_str = n.props_obj.preloaderFontColor
					|| "#000000";
			n.preloaderBackgroundColor_str = n.props_obj.preloaderBackgroundColor
					|| "transparent";
			n.preloaderText_str = n.props_obj.preloaderText || "Loading:";
			n.startDraggingMode_str = n.props_obj.startDraggingMode || "rotate";
			if (n.startDraggingMode_str != "rotate"
					&& n.startDraggingMode_str != "pan")
				n.startDraggingMode_str = "rotate";
			n.controllerPosition_str = n.props_obj.controllerPosition
					|| "bottom";
			if (n.controllerPosition_str != "top"
					&& n.controllerPosition_str != "bottom")
				n.startDraggingMode_str = "top";
			...
			if (n.isMobile_bl && !n.hasPointerEvent_bl) {
				...
				if (n.props_obj.buttonsToolTips)
					n.buttonsLabels_ar = FWDUtils.splitAndTrim(
							n.props_obj.buttonsToolTips, false);
				if (n.props_obj.contextMenuLabels)
					n.contextMenuLabels_ar = FWDUtils.splitAndTrim(
							n.props_obj.contextMenuLabels, false)
			}
			n.showScriptDeveloper_bl = n.props_obj.showScriptDeveloper;
			n.showScriptDeveloper_bl = n.showScriptDeveloper_bl == "no" ? false
					: true;
			n.dragRotationSpeed = n.props_obj.dragRotationSpeed || .5;
			if (isNaN(n.dragRotationSpeed))
				n.dragRotationSpeed = .5;
			...
			if (isNaN(n.dragAndSpinSpeed))
				n.dragAndSpinSpeed = .4;
			...
			if (isNaN(n.buttonsRotationSpeed))
				n.buttonsRotationSpeed = 500;
			...
			if (isNaN(n.navigatorOffsetX))
				n.navigatorOffsetX = 0;
			n.navigatorOffsetY = n.props_obj.navigatorOffsetY || 0;
			if (isNaN(n.navigatorOffsetY))
				n.navigatorOffsetY = 0;
			n.controllerBackgroundOpacity = n.props_obj.controllerBackgroundOpacity;
			if (!n.controllerBackgroundOpacity)
				n.controllerBackgroundOpacity = 1;
			if (isNaN(n.controllerBackgroundOpacity))
				n.controllerBackgroundOpacity = 1;
			...
			if (!n.controllerMaxWidth)
				n.controllerMaxWidth = 900;
			if (isNaN(n.controllerMaxWidth))
				n.controllerMaxWidth = 900;
			if (n.controllerMaxWidth < 200)
				n.controllerMaxWidth = 200;
			...
			n.buttonToolTipFontColor_str = n.props_obj.buttonToolTipFontColor
					|| "#000000";
			n.link_str = n.props_obj.link
					|| "http://www.link-is-not-defined.com!";
			n.contextMenuBackgroundColor_str = n.props_obj.contextMenuBackgroundColor
					|| "#000000";
			n.contextMenuBorderColor_str = n.props_obj.contextMenuBorderColor
					|| "#FF0000";
			n.contextMenuSpacerColor_str = n.props_obj.contextMenuSpacerColor
					|| "#FF0000";
			n.contextMenuItemNormalColor_str = n.props_obj.contextMenuItemNormalColor
					|| "#FF0000";
			n.contextMenuItemSelectedColor_str = n.props_obj.contextMenuItemSelectedColor
					|| "#FF0000";
			n.contextMenuItemDisabledColor_str = n.props_obj.contextMenuItemDisabledColor
					|| "#FF0000";
			n.infoWindowBackgroundColor_str = n.props_obj.infoWindowBackgroundColor
					|| "#FF0000";
			n.infoWindowScrollBarColor_str = n.props_obj.infoWindowScrollBarColor
					|| "#FF0000";
			n.navigatorPosition_str = n.props_obj.navigatorPosition
					|| "topleft";
			n.navigatorPosition_str = String(n.navigatorPosition_str)
					.toLowerCase();
			l = n.navigatorPosition_str == "topleft"
					|| n.navigatorPosition_str == "topright"
					|| n.navigatorPosition_str == "bottomleft"
					|| n.navigatorPosition_str == "bottomright";
			if (!l)
				n.navigatorPosition_str = "topleft";
			n.navigatorHandlerColor_str = n.props_obj.navigatorHandlerColor
					|| "#FF0000";
			n.navigatorBorderColor_str = n.props_obj.navigatorBorderColor
					|| "#FF0000";
			n.slideShowDelay = n.props_obj.slideShowDelay || 100;
			if (n.slideShowDelay < 100)
				n.slideShowDelay = 100;
			...
			n.inverseNextAndPrevRotation_bl = n.inverseNextAndPrevRotation_bl == "yes" ? true
					: false;
			n.addCorrectionForWebKit_bl = n.props_obj.addCorrectionForWebKit;
			n.addCorrectionForWebKit_bl = n.addCorrectionForWebKit_bl == "yes" ? true
					: false;
			if (!FWDUtils.isChrome || n.hasTouch_bl)
				n.addCorrectionForWebKit_bl = false;
			n.useEntireScreenFor3dObject_bl = n.props_obj.useEntireScreenFor3dObject;
			n.useEntireScreenFor3dObject_bl = n.useEntireScreenFor3dObject_bl == "yes" ? true
					: false;
			n.infoText_str = FWDUtils.getChildFromNodeListFromAttribute(
					n.rootElement_el, "data-info");
			if (n.infoText_str) {
			...
			if (!n.handMovePath_str)
				return;
			n.handGrabRotatePath_str = n.checkForAttribute(e,
					"data-hand-rotate-path");
			if (!n.handGrabRotatePath_str)
				return;
			n.handGrabPath_str = n.checkForAttribute(e, "data-hand-grab-path");
			if (!n.handGrabPath_str)
				return;
			var S = n.checkForAttribute(e, "data-preloader-path");
			if (!S)
				return;
			var x = n.checkForAttribute(e,
					"data-main-lightbox-close-button-normal-path");
			if (!x)
				return;
			var T = n.checkForAttribute(e,
					"data-main-lightbox-close-button-selected-path");
			if (!x)
				return;
			var N = n.checkForAttribute(e,
					"data-controller-background-left-path");
			if (!N)
				return;
			var C = n.checkForAttribute(e,
					"data-controller-background-right-path");
			if (!C)
				return;
			var k = n.checkForAttribute(e,
					"data-controller-pan-button-normal-state-path");
			if (!k)
				return;
			var L = n.checkForAttribute(e,
					"data-controller-pan-button-selected-state-path");
			if (!L)
				return;
			var A = n.checkForAttribute(e,
					"data-controller-rotate-button-normal-state-path");
			if (!A)
				return;
			var O = n.checkForAttribute(e,
					"data-controller-rotate-button-selected-state-path");
			if (!O)
				return;
			var M = n.checkForAttribute(e,
					"data-controller-next-button-normal-state-path");
			if (!M)
				return;
			var _ = n.checkForAttribute(e,
					"data-controller-next-button-selected-state-path");
			if (!_)
				return;
			var D = n.checkForAttribute(e,
					"data-controller-prev-button-normal-state-path");
			if (!D)
				return;
			var P = n.checkForAttribute(e,
					"data-controller-prev-button-selected-state-path");
			if (!P)
				return;
			var H = n.checkForAttribute(e,
					"data-controller-play-button-normal-state-path");
			if (!H)
				return;
			var B = n.checkForAttribute(e,
					"data-controller-play-button-selected-state-path");
			if (!B)
				return;
			var j = n.checkForAttribute(e,
					"data-controller-pause-button-normal-state-path");
			if (!j)
				return;
			var F = n.checkForAttribute(e,
					"data-controller-pause-button-selected-state-path");
			if (!F)
				return;
			var I = n.checkForAttribute(e,
					"data-controller-info-button-normal-state-path");
			if (!I)
				return;
			var q = n.checkForAttribute(e,
					"data-controller-info-button-selected-state-path");
			if (!q)
				return;
			var R = n.checkForAttribute(e,
					"data-controller-link-button-normal-state-path");
			if (!R)
				return;
			var U = n.checkForAttribute(e,
					"data-controller-link-button-selected-state-path");
			if (!U)
				return;
			var z = n
					.checkForAttribute(e,
							"data-controller-fullscreen-normal-button-normal-state-path");
			if (!z)
				return;
			var W = n
					.checkForAttribute(e,
							"data-controller-fullscreen-normal-button-selected-state-path");
			if (!W)
				return;
			var X = n.checkForAttribute(e,
					"data-controller-fullscreen-full-button-normal-state-path");
			if (!X)
				return;
			var V = n
					.checkForAttribute(e,
							"data-controller-fullscreen-full-button-selected-state-path");
			if (!V)
				return;
			var $ = n.checkForAttribute(e,
					"data-controller-zoomin-button-normal-state-path");
			if (!$)
				return;
			var J = n.checkForAttribute(e,
					"data-controller-zoomin-button-slected-state-path");
			if (!J)
				return;
			var K = n.checkForAttribute(e,
					"data-controller-zoomout-button-normal-state-path");
			if (!K)
				return;
			var Q = n.checkForAttribute(e,
					"data-controller-zoomout-button-slected-state-path");
			if (!Q)
				return;
			var G = n.checkForAttribute(e,
					"data-controller-scrollbar-handler-normal-state-path");
			if (!G)
				return;
			var Y = n.checkForAttribute(e,
					"data-controller-scrollbar-handler-selected-state-path");
			if (!Y)
				return;
			var Z = n.checkForAttribute(e,
					"data-controller-scrollba-background-left-path");
			if (!Z)
				return;
			var et = n.checkForAttribute(e,
					"data-controller-scrollbar-background-right-path");
			if (!et)
				return;
			n.scrollBarMiddlePath_str = n.checkForAttribute(e,
					"data-controller-scrollbar-background-middle-path");
			if (!n.scrollBarMiddlePath_str)
				return;
			n.controllerBackgroundMiddlePath_str = n.checkForAttribute(e,
					"data-controller-background-center-path");
			if (!n.controllerBackgroundMiddlePath_str)
				return;
			n.buttonToolTipLeft_str = n.checkForAttribute(e,
					"data-button-tooltip-left-path");
			if (!n.buttonToolTipLeft_str)
				return;
			n.buttonToolTipMiddle_str = n.checkForAttribute(e,
					"data-button-tooltip-middle-path");
			if (!n.buttonToolTipMiddle_str)
				return;
			n.buttonToolTipRight_str = n.checkForAttribute(e,
					"data-button-tooltip-right-path");
			if (!n.buttonToolTipRight_str)
				return;
			n.buttonToolTipBottomPointer_str = n.checkForAttribute(e,
					"data-button-tooltip-bottom-pointer-path");
			if (!n.buttonToolTipBottomPointer_str)
				return;
			n.buttonToolTipTopPointer_str = n.checkForAttribute(e,
					"data-button-tooltip-top-pointer-path");
			if (!n.buttonToolTipTopPointer_str)
				return;
			var tt = n.checkForAttribute(e,
					"data-info-window-close-button-normal-state-path");
			if (!tt)
				return;
			var nt = n.checkForAttribute(e,
					"data-info-window-close-button-selected-state-path");
			if (!nt)
				return;
			...
			for (var b = 0; b < n.totalImages; b++) {
				...
				if (n.showLargeImageVersionOnZoom_bl)
					n.largeImagesPaths_ar[b] = n.playListData_ar[b].largeImagePath;
				if (n.showNavigator_bl)
					n.navigatorImagesPaths_ar[b] = n.playListData_ar[b].navigatorImagePath
			}
		};
		n.loadSkin = function() {
			if (n.image_img) {
		...
		n.onKinLoadErrorHandler = function(e) {
			var r = "The skin graphics with the label <font color='#FFFFFF'>"
					+ n.skinPaths_ar[n.countLoadedSkinImages]
					+ "</font> can't be loaded, make sure that the image exists and the path is correct!";
			console.log(e);
			var i = {
				text : r
			};
		...
		n.onImageLoadHandler = function(e) {
			if (n.countLoadedImages == 0)
				n.dispatchEvent(t.FIRST_IMAGE_LOAD_COMPLETE);
			...
			if (n.showNavigator_bl && n.countLoadedImages != 0) {
				...
				if (n.countLoadedImages == n.totalImages - 1)
					n.navigatorImage_img.onload = n.onLastNavigatorImageLoadHandler;
		...
		n.onNavigatorImageLoadErrorHandler = function(e) {
			var r = "The navigator image with the label <font color='#FFFFFF'>"
					+ n.navigatorImagesPaths_ar[n.countLoadedImages]
					+ "</font> can't be loaded, make sure that the image exists and the path is correct!";
		...
		n.onImageLoadErrorHandler = function(e) {
			var r = "The image with the label <font color='#FFFFFF'>"
					+ n.imagesPaths_ar[n.countLoadedImages]
					+ "</font> can't be loaded, make sure that the image exists and the path is correct!";
			console.log(e);
			var i = {
				text : r
				...
				if (i != undefined) {
					n
							.dispatchEvent(
									t.LOAD_ERROR,
									{
										text : "Element with attribute <font color='#FFFFFF'>"
												+ r
												+ "</font> is not defined at positon <font color='#FFFFFF'>"
												+ (i + 1) + "</font>"
									})
				} else {
					n.dispatchEvent(t.LOAD_ERROR, {
						text : "Element with attribute <font color='#FFFFFF'>"
								+ r + "</font> is not defined."
					})
				}
				return
			}
		...
		n.showPropertyError = function(e) {
			n.dispatchEvent(t.LOAD_ERROR, {
				text : "The property called <font color='#FFFFFF'>" + e
						+ "</font> is not defined."
			})
		};
		n.showMarkerError = function(e, r) {
			n
					.dispatchEvent(
							t.LOAD_ERROR,
							{
								text : "The marker at position <font color='#FFFFFF'>"
										+ r
										+ "</font> dose not have defined an attribute <font color='#FFFFFF'>"
										+ e + "</font>."
							})
		};
		n.showMarkerTypeError = function(e, r) {
			n
					.dispatchEvent(
							t.LOAD_ERROR,
							{
								text : "Marker type is incorrect <font color='#FFFFFF'>"
										+ e
										+ "</font> at position <font color='#FFFFFF'>"
										+ r
										+ "</font>. Accepted types are <font color='#FFFFFF'>link, tooltip, infowindow</font>."
							})
		};
		n.destroy = function() {
			var e;
			...
			if (n.mainPreloader_img)
				n.mainPreloader_img.src = null;
			if (n.mainLightboxCloseButtonN_img)
				n.mainLightboxCloseButtonN_img.src = null;
			if (n.mainLightboxCloseButtonS_img)
				n.mainLightboxCloseButtonS_img.src = null;
			if (n.controllerBackgroundLeft_img)
				n.controllerBackgroundLeft_img.src = null;
			if (n.controllerBackgroundRight_img)
				n.controllerBackgroundRight_img.src = null;
			if (n.controllerPanN_img)
				n.controllerPanN_img.src = null;
			if (n.controllerPanS_img)
				n.controllerPanS_img.src = null;
			if (n.controllerRotateN_img)
				n.controllerRotateN_img.src = null;
			if (n.controllerRotateS_img)
				n.controllerRotateS_img.src = null;
			if (n.controllerNextN_img)
				n.controllerNextN_img.src = null;
			if (n.controllerNextS_img)
				n.controllerNextS_img.src = null;
			if (n.controllerPrevN_img)
				n.controllerPrevN_img.src = null;
			if (n.controllerPrevS_img)
				n.controllerPrevS_img.src = null;
			if (n.controllerPlayN_img)
				n.controllerPlayN_img.src = null;
			if (n.controllerPlayS_img)
				n.controllerPlayS_img.src = null;
			if (n.controllerPauseN_img)
				n.controllerPauseN_img.src = null;
			if (n.controllerPauseS_img)
				n.controllerPauseS_img.src = null;
			if (n.controllerInfoN_img)
				n.controllerInfoN_img.src = null;
			if (n.controllerLinkN_img)
				n.controllerLinkN_img.src = null;
			if (n.controllerLinkS_img)
				n.controllerLinkS_img.src = null;
			if (n.controllerFullScreenNormalN_img)
				n.controllerFullScreenNormalN_img.src = null;
			if (n.controllerFullScreenNormalS_img)
				n.controllerFullScreenNormalS_img.src = null;
			if (n.controllerFullScreenFullN_img)
				n.controllerFullScreenFullN_img.src = null;
			if (n.controllerFullScreenFullS_img)
				n.controllerFullScreenFullS_img.src = null;
			if (n.zoomInN_img)
				n.zoomInN_img.src = null;
			if (n.zoomInS_img)
				n.zoomInS_img.src = null;
			if (n.zoomOutN_img)
				n.zoomOutN_img.src = null;
			if (n.zoomOutS_img)
				n.zoomOutS_img.src = null;
			if (n.scrollBarHandlerN_img)
				n.scrollBarHandlerN_img.src = null;
			if (n.scrollBarHandlerN_img)
				n.scrollBarHandlerN_img.src = null;
			if (n.scrollBarHandlerS_img)
				n.scrollBarHandlerS_img.src = null;
			if (n.scrollBarLeft_img)
				n.scrollBarLeft_img.src = null;
			if (n.scrollBarLeft_img)
				n.scrollBarLeft_img.src = null;
			if (n.scrollBarRight_img)
				n.scrollBarRight_img.src = null;
			if (n.toolTipLeft_img)
				n.toolTipLeft_img.src = null;
			if (n.toolTipPointer_img)
				n.toolTipPointer_img.src = null;
			if (n.infoWindowCloseNormal_img)
				n.infoWindowCloseNormal_img.src = null;
			if (n.infoWindowCloseSelected_img)
				n.infoWindowCloseSelected_img.src = null;
...
(function(e) {
	var t = function(n, r) {
		...
		i.resizeAndPosition = function() {
			if (i.stageWidth == n.stageWidth && i.stageHeight == n.stageHeight)
				return;
		...
		i.setupCloseButton = function() {
			FWDSimpleButton.setPrototype();
			i.close_do = new FWDSimpleButton(i.infoWindowCloseNormal_img,
					i.infoWindowCloseSelected_img);
			i.close_do.addListener(FWDSimpleButton.MOUSE_DOWN,
					i.closeButtonStartHandler);
		...
		i.updateSize = function() {
			...
			if (i.mainContentHolderWidth > i.maxWidth)
				i.mainContentHolderWidth = i.maxWidth;
			...
			if (i.isMobile_bl) {
				setTimeout(
						function() {
							...
							i.contentHolderHeight = i.contentHolder_sdo
									.getHeight();
							i.mainContentHolderHeight = Math.min(i.stageHeight,
									i.contentHolderHeight);
							i.mainContentFinalX = Math
									.round((i.stageWidth - i.mainContentHolderWidth) / 2);
							if (i.stageHeight > i.contentHolderHeight) {
								i.mainContentFinalY = Math
										.round((i.stageHeight - i.contentHolderHeight) / 2);
							...
							i.mainContentHolder_do
									.setHeight(i.mainContentHolderHeight)
						}, 50)
			} else {
				setTimeout(
						function() {
							...
							i.mainContentFinalX = Math
									.round((i.stageWidth - i.mainContentHolderWidth) / 2);
							i.scrollBarHeight = Math.min(i.contentHolderHeight
									- 20 - i.closeButtonHeight, i.stageHeight
									- 20 - i.closeButtonHeight);
							if (i.stageHeight > i.contentHolderHeight) {
							...
							if (i.stageHeight < 120)
								i.mainContentFinalY = 0;
							i.scrollBarHandlerHeight = Math.min(
									i.scrollBarHeight - 20, i.stageHeight / i.contentHolderHeight
											* (i.scrollBarHeight - 20));
							if (i.scrollBarHandlerHeight > 500) {
								i.scrollBarHandlerHeight = 500
							}
							i.scrollBar_do.setX(i.mainContentHolderWidth
									- i.scrollBarWidth - 2);
							i.scrollBarTrack_sdo.setHeight(Math
									.max(i.scrollBarHeight,
											i.scrollBarHandlerHeight));
							i.scrollBarHandler_sdo
									.setHeight(i.scrollBarHandlerHeight);
							TweenMax.killTweensOf(i.mainContentHolder_do);
							i.mainContentHolder_do.setX(i.mainContentFinalX);
							i.mainContentHolder_do.setY(i.mainContentFinalY);
							i.mainContentHolder_do
		...
		i.setupPCScrollBar = function() {
			...
			i.scrollBarTrack_sdo.getStyle().borderRadius = i.scrollBarBorderRadius
					+ "px";
			...
			i.scrollBarHandler_sdo.getStyle().borderRadius = i.scrollBarBorderRadius
					+ "px";
			...
			if (i.scrollBarHandler_sdo.screen.addEventListener) {
				i.scrollBarHandler_sdo.screen.addEventListener("mouseover",
						i.scrollBarHandlerOnMouseOver);
				i.scrollBarHandler_sdo.screen.addEventListener("mouseout",
						i.scrollBarHandlerOnMouseOut);
				i.scrollBarHandler_sdo.screen.addEventListener("mousedown",
						i.scrollBarHandlerOnMouseDown)
			} else if (i.screen.attachEvent) {
				i.scrollBarHandler_sdo.screen.attachEvent("onmouseover",
						i.scrollBarHandlerOnMouseOver);
				i.scrollBarHandler_sdo.screen.attachEvent("onmouseout",
						i.scrollBarHandlerOnMouseOut);
				i.scrollBarHandler_sdo.screen.attachEvent("onmousedown",
						i.scrollBarHandlerOnMouseDown)
			}
		...
		i.scrollBarHandlerMoveHandler = function(e) {
			if (e.preventDefault)
				e.preventDefault();
			var t = FWDUtils.getViewportMouseCoordinates(e);
			i.scrollBarHandlerFinalY = Math.round(i.yPositionOnPress
					+ t.screenY - i.lastPresedY);
			if (i.scrollBarHandlerFinalY >= i.scrollBarHeight
					- i.scrollBarHandlerHeight) {
				i.scrollBarHandlerFinalY = i.scrollBarHeight
						- i.scrollBarHandlerHeight
			}
		...
		i.scrollBarHandlerEndHandler = function(t) {
			...
			if (!FWDUtils.hitTest(i.scrollBarHandler_sdo.screen, n.screenX,
					n.screenY)) {
				i.scrollBarHandlerOnMouseOut()
			}
		...
		i.updatePCHandler = function(e) {
			...
			if (n >= 1)
				n = 1;
			if (i.isDragging_bl) {
				i.contentFinalY = parseInt(n
						* (i.stageHeight - i.contentHolderHeight))
			} else {
				if (i.scrollBarHandler_sdo.getY() < 0) {
					i.scrollBarHandler_sdo.setY(0)
				} else if (i.scrollBarHandler_sdo.getY() > i.scrollBarHeight
						- i.scrollBarHandlerHeight) {
					i.scrollBarHandler_sdo.setY(i.scrollBarHeight
							- i.scrollBarHandlerHeight)
				}
				...
				if (i.stageHeight > i.contentHolderHeight) {
					...
					i.contentFinalY = Math.round(t
							* (i.scrollBarHeight - i.scrollBarHandlerHeight));
					i.contentFinalY = Math.round(t
							* (i.stageHeight - i.contentHolderHeight))
				}
			}
		...
		i.addMouseWheelSupport = function() {
			if (e.addEventListener) {
				...
				i.screen
						.addEventListener("DOMMouseScroll", i.mouseWheelHandler)
			} else if (document.attachEvent) {
		...
		this.mouseWheelHandler = function(e) {
			...
			if (FWDUtils.isOpera)
				n *= -1;
			if (n > 0) {
				i.scrollBarHandler_sdo.setY(i.scrollBarHandler_sdo.getY() + 45
						* t)
			} else if (n < 0) {
				i.scrollBarHandler_sdo.setY(i.scrollBarHandler_sdo.getY() - 45
						* t)
		...
		i.setupMobileScrollbar = function() {
			if (i.hasPointerEvent_bl) {
				i.screen.addEventListener("MSPointerDown",
						i.scrollBarTouchStartHandler)
			} else {
				i.screen.addEventListener("touchstart",
						i.scrollBarTouchStartHandler)
			}
		};
		...
		i.updateMobileScrollBar = function(e) {
			if (!i.isDragging_bl) {
				...
				} else if (i.contentFinalY < i.mainContentHolderHeight
						- i.contentHolderHeight) {
		...
		i.updateMobileScrollBarWithoutAnimation = function() {
			if (i.contentFinalY > 0) {
				i.contentFinalY = 0
					...
					- i.contentHolderHeight) {
				i.contentFinalY = i.mainContentHolderHeight
						- i.contentHolderHeight
			}
			i.contentHolder_sdo.setY(Math.round(i.contentFinalY))
		};
		i.activateScrollBar = function() {
			if (i.isMobile_bl) {
				i.updateMobileScrollBarId_int = setInterval(
						i.updateMobileScrollBar, 16)
			}
		};
		i.show = function(e) {
			if (i.isShowed_bl)
		...
		i.showWithDelay = function() {
			...
			if (i.scrollBarHandler_sdo)
				i.scrollBarHandler_sdo.setVisible(true);
		...
		i.hide = function(e, t) {
			...
			if (e) {
				...
				if (i.scrollBarHandler_sdo)
					i.scrollBarHandler_sdo.setVisible(false);
		...
		i.cleanMainEvents = function() {
			if (i.screen.removeEventListener) {
				if (i.scrollBarHandler_sdo) {
					i.scrollBarHandler_sdo.screen.removeEventListener(
							"mouseover", i.scrollBarHandlerOnMouseOver);
					i.scrollBarHandler_sdo.screen.removeEventListener(
							"mouseout", i.scrollBarHandlerOnMouseOut);
					i.scrollBarHandler_sdo.screen.removeEventListener(
							"mousedown", i.scrollBarHandlerOnMouseDown)
				}
				e.removeEventListener("mousemove",
						i.scrollBarHandlerMoveHandler);
				e.removeEventListener("mouseup", i.scrollBarHandlerEndHandler);
				i.screen.removeEventListener("mousewheel", i.mouseWheelHandler);
				i.screen.removeEventListener("DOMMouseScroll",
						i.mouseWheelHandler);
				i.screen.addEventListener("MSPointerDown",
						i.scrollBarTouchStartHandler);
				i.screen.addEventListener("touchstart",
				...
				i.scrollBarHandler_sdo.screen.detachEvent("onmouseover",
						i.scrollBarHandlerOnMouseOver);
				i.scrollBarHandler_sdo.screen.detachEvent("onmouseout",
						i.scrollBarHandlerOnMouseOut);
				i.scrollBarHandler_sdo.screen.detachEvent("onmousedown",
						i.scrollBarHandlerOnMouseDown);
				document.detachEvent("onmousemove",
						i.scrollBarHandlerMoveHandler);
				document.detachEvent("onmouseup", i.scrollBarHandlerEndHandler);
...
(function(e) {
	var t = function(e, t, n, r) {
		...
		if (FWDUtils.isIE || FWDUtils.isFirefox)
		...
		i.getTransform = function() {
			var e = [ "transform", "msTransform", "WebkitTransform",
		...
		i.setAlpha = function(e) {
			...
			if (i.opacityType == "opacity") {
				...
				i.screen.style.filter = "progid:DXImageTransform.Microsoft.Alpha(Opacity="
						+ Math.round(i.alpha * 100) + ")"
			}
		};
		i.getAlpha = function() {
			return i.alpha
		...
		i.setX = function(e) {
			...
			if (i.hasTransform3d_bl) {
				i.screen.style[i.transform] = "translate3d(" + i.x + "px,"
						+ i.y + "px,0)"
			} else if (i.hasTransform2d_bl) {
				i.screen.style[i.transform] = "translate(" + i.x + "px," + i.y
						+ "px)"
			} else {
		...
		i.addChild = function(e) {
			if (i.contains(e)) {
				i.children_ar
						.splice(FWDUtils.indexOfArray(i.children_ar, e), 1);
		...
		i.addChildAt = function(e, t) {
			if (i.getNumChildren() == 0) {
				...
				if (i.contains(e)) {
					i.children_ar.splice(FWDUtils
							.indexOfArray(i.children_ar, e), 1, e)
				} else {
					i.children_ar.splice(FWDUtils
							.indexOfArray(i.children_ar, e), 0, e)
				}
			} else {
				if (t < 0 || t > i.getNumChildren() - 1)
		...
		i.dispatchEvent = function(e, t) {
			...
			for (var n = 0, r = this.listeners.events_ar.length; n < r; n++) {
				if (this.listeners.events_ar[n].target === this
						&& this.listeners.events_ar[n].type === e) {
					if (t) {
						for ( var i in t) {
							this.listeners.events_ar[n][i] = t[i]
						}
					}
					this.listeners.events_ar[n].listener.call(this,
							this.listeners.events_ar[n])
				}
			}
		};
		i.removeListener = function(e, t) {
			...
			for (var n = 0, r = this.listeners.events_ar.length; n < r; n++) {
				if (this.listeners.events_ar[n].target === this
						&& this.listeners.events_ar[n].type === e
						&& this.listeners.events_ar[n].listener === t) {
...
(function(e) {
	var t = function(e, n, r) {
		...
		i.addMouseOrTouchCheck = function() {
			if (i.isMobile_bl) {
				if (i.hasPointerEvent_bl) {
					i.screenToTest.screen.addEventListener("MSPointerDown",
							i.onMouseOrTouchUpdate);
					i.screenToTest.screen.addEventListener("MSPointerMove",
							i.onMouseOrTouchUpdate)
				} else {
					i.screenToTest.screen.addEventListener("touchstart",
							i.onMouseOrTouchUpdate)
				}
			} else if (i.screenToTest.screen.addEventListener) {
				i.screenToTest.screen.addEventListener("mousemove",
						i.onMouseOrTouchUpdate)
			} else if (i.screenToTest.screen.attachEvent) {
				i.screenToTest.screen.attachEvent("onmousemove",
						i.onMouseOrTouchUpdate)
			}
		};
		i.removeMouseOrTouchCheck = function() {
			if (i.isMobile_bl) {
				if (i.hasPointerEvent_bl) {
					i.screenToTest.screen.removeEventListener("MSPointerDown",
							i.onMouseOrTouchUpdate);
					i.screenToTest.screen.removeEventListener("MSPointerMove",
							i.onMouseOrTouchUpdate)
				} else {
					i.screenToTest.screen.removeEventListener("touchstart",
							i.onMouseOrTouchUpdate)
				}
			} else if (i.screenToTest.screen.removeEventListener) {
				i.screenToTest.screen.removeEventListener("mousemove",
						i.onMouseOrTouchUpdate)
			} else if (i.screenToTest.screen.detachEvent) {
				i.screenToTest.screen.detachEvent("onmousemove",
						i.onMouseOrTouchUpdate)
			}
		};
...
(function() {
	var e = function(t, n) {
		...
		this.hasPointerEvent_bl = FWDUtils.hasPointerEvent;
		r.init = function() {
			if (r.controllerPosition_str == FWDController.POSITION_TOP
					&& !r.useEntireScreenFor3dObject_bl)
				r.setY(r.controllerHeight);
			r.setupMainContiners();
			r.setupDumy();
			if (r.showMarkers_bl) {
				r.setupMarkers();
				if (!r.isMobile_bl || r.hasPointerEvent_bl)
					r.setupMarkersToolTip();
		...
		r.setupMainContiners = function() {
			...
			r.mainImagesHolder_do = new FWDDisplayObject("div", "absolute",
					"visible");
			...
			if (r.addCorrectionForWebKit_bl)
				r.setupCorrectionLinesForChrome()
		};
		...
		r.showLoadedImage = function(e) {
			...
			if (FWDUtils.isAndroid)
				r.smallImage_sdo.setBackfaceVisibility();
			...
			r.removeSmallSDOId_to = setTimeout(function() {
				if (r == null)
					return;
				if (e > 0)
					r.smallDos_ar[e - 1].setVisible(false)
			}, 40);
			r.resizeAndPosition();
			r.resiezeAndPositionIfNotAllImagesAreLoaded()
		};
		r.activate = function() {
			...
			if (r.showMarkersInfo_bl)
				r.setupMarkersInfo()
		};
		r.setupDumy = function() {
			r.dumy_sdo = new FWDSimpleDisplayObject("div");
			if (FWDUtils.isIE)
				r.dumy_sdo.getStyle().background = "url('dumy')";
			if (!r.showMarkersInfo_bl)
				r.dumy_sdo.getStyle().cursor = "url(" + r.handMovePath_str
						+ "), default";
		...
		r.addSmallImage = function() {
			...
			if (r.mainImagesHolder_do.contains(r.largeImage_sdo))
				r.mainImagesHolder_do.removeChild(r.largeImage_sdo);
			if (!r.addImageFirstTimeOnActivate_bl) {
				r.smallImage_sdo.setVisible(false);
				r.smallImage_sdo = r.smallDos_ar[r.curId];
				r.smallImage_sdo.setVisible(true)
		...
		r.addLargeImage = function() {
			if (!r.showLargeImageVersionOnZoom_bl)
				return;
			if (r.currentScale <= 1)
				return;
			if (r.curLargeImageId == r.curId)
				return;
		...
		r.largeImageErrorHandler = function() {
			var t = "The large image labeled <font color='#FFFFFF'>"
					+ r.largeImagesPaths_ar[r.curId]
					+ "</font> can't be loaded, make sure that the image exists and the path is correct!";
		...
		r.resizeAndPositionAfterAllLoad = function() {
			...
			if (r.addCorrectionForWebKit_bl)
				r.resizeAndPositionCorrectionLines(false);
		...
		r.resizeAndPositionLargeImage = function(e) {
			if (!r.showLargeImageVersionOnZoom_bl || !r.isLargeImageLoaded_bl)
				return;
		...
		r.zoomImage = function(e) {
			if (e) {
				r.finalWidth = Math.round(r.currentScale * r.imageWidth);
				r.finalHeight = Math.round(r.currentScale * r.imageHeight);
				r.finalX -= Math.round((r.mouseX - r.finalX)
						* (r.currentScale - r.prevScale) / r.prevScale);
				r.finalY -= Math.round((r.mouseY - r.finalY)
						* (r.currentScale - r.prevScale) / r.prevScale)
			}
			...
			if (r.addCorrectionForWebKit_bl)
				r.resizeAndPositionCorrectionLines(true);
			if (r.showNavigator_bl) {
				r.hideOrShowNavigator();
		...
		r.addPinchSupport = function() {
			if (r.screen.addEventListener) {
				r.screen.addEventListener("gesturestart",
		...
		r.gestureChangeHandler = function(e) {
			...
			if (parseFloat(r.currentScale.toFixed(5)) <= parseFloat(r.smallestPossibleScale
					.toFixed(5))) {
				r.currentScale = r.smallestPossibleScale
		...
		r.addPannSupport = function() {
			if (r.isMobile_bl) {
				if (r.hasPointerEvent_bl) {
					r.dumy_sdo.screen.addEventListener("MSPointerDown",
							r.panStartHandler)
				} else {
					r.dumy_sdo.screen.addEventListener("touchstart",
							r.panStartHandler)
				}
			} else if (r.screen.addEventListener) {
				r.dumy_sdo.screen.addEventListener("mousedown",
						r.panStartHandler)
		...
		r.panStartHandler = function(t) {
			if (r.draggingMode_str != e.PAN || r.isTweening_bl
					|| r.disablePanOrRotate_bl)
				return;
			if (t.preventDefault)
				t.preventDefault();
			if (r.finalWidth < r.stageWidth && r.finalHeight < r.stageHeight)
				return;
		...
		r.panMoveHandler = function(e) {
			if (e.preventDefault)
				e.preventDefault();
			if (e.touches && e.touches.length != 1 || r.disablePanOrRotate_bl)
				return;
			var t = FWDUtils.getViewportMouseCoordinates(e);
			if (r.finalWidth > r.stageWidth + 1) {
				r.finalX = Math.round(r.xPositionOnPress + t.screenX
						- r.lastPresedX);
				if (r.finalX > 0) {
					r.finalX = 0
				} else if (r.finalX <= r.stageWidth - r.finalWidth + 1) {
			...
			if (r.finalHeight > r.stageHeight + 1) {
				r.finalY = Math.round(r.yPositionOnPress + t.screenY
						- r.lastPresedY);
				if (r.finalY > 0) {
					r.finalY = 0
				} else if (r.finalY <= r.stageHeight - r.finalHeight) {
		...
		r.panEndHandler = function(e) {
			...
			if (!r.isMobile_bl || e.pointerType == e.MSPOINTER_TYPE_MOUSE)
				n.hidePanDumy();
			if (r.isMobile_bl) {
				if (r.hasPointerEvent_bl) {
					window.removeEventListener("MSPointerMove",
		...
		r.addRotationSupport = function() {
			if (r.isMobile_bl) {
				...
				r.dumy_sdo.screen.attachEvent("onmousedown",
						r.rotateStartHandler)
			}
		};
		r.rotateStartHandler = function(t) {
			if (r.draggingMode_str != e.ROTATE || r.isTweening_bl
					|| r.disablePanOrRotate_bl)
				return;
		...
		r.rotateEndHandler = function(e) {
			if (Math.abs(r.swipeDragDist) > r.spinDist
					&& r.addDragAndSpinSupport_bl
					&& r.firstInteractionOccured_bl) {
				r.startToSwipe()
			} else {
				r.addLargeImage()
			}
		...
		r.addMouseWheelSupport = function() {
			if (window.addEventListener) {
				r.dumy_sdo.screen.addEventListener("mousewheel",
						r.mouseWheelHandler);
				r.dumy_sdo.screen.addEventListener("DOMMouseScroll",
						r.mouseWheelHandler)
			} else if (document.attachEvent) {
				r.dumy_sdo.screen.attachEvent("onmousewheel",
						r.mouseWheelHandler)
			}
		};
		r.mouseWheelHandler = function(e) {
			if (e.preventDefault)
				e.preventDefault();
			if (r.isDragging_bl || r.disablePanOrRotate_bl)
				return;
			var t = FWDUtils.getViewportMouseCoordinates(e);
			if (r.hider)
				r.hider.reset();
		...
		r.setupMarkers = function() {
			...
			for (var i = 0; i < r.totalMarkers; i++) {
				...
				e = new FWDMarker(t.markerId, t.normalStatePath_str,
						t.selectedStatePath_str, t.type, t.regPoint,
						t.toolTipLabel, t.markerWidth, t.markerHeight);
		...
		r.markerOnMouseOverHandler = function(e) {
			...
			if (t.type_str == "tooltip") {
				if (r.lastMarkerId_str != t.markerId)
					r.hideToolTipWindow();
				r.lastMarkerId_str = t.markerId;
				r.curMarker_do = t;
				clearTimeout(r.hideToolTipWindowId_to);
				r
						.showToolTipWindow(t, t.innerHTML_str,
								t.toolTipWindowMaxWidth)
			}
		};
		r.markerOnMouseOutHandler = function(e) {
			...
			if (t.hasToolTip_bl) {
				if (r.markersToolTip_do) {
					if (r.contains(r.markersToolTip_do))
						r.removeChild(r.markersToolTip_do);
			...
			if (t.type_str == "tooltip") {
				...
				clearTimeout(r.hideToolTipWindowId_to);
				r.hideToolTipWindowId_to = setTimeout(
						r.hideToolTipWindowWithDelay, 300)
			}
		};
		r.markerOnStartHandler = function(t) {
			...
			if (n.type_str == "infowindow") {
				...
				if (r.lastMarkerId_str != n.markerId)
					r.hideToolTipWindow();
				r.curMarker_do = n;
				r.lastMarkerId_str = n.markerId;
				r.toolTipWindowAddEventsToSetGlobalXAndGlobalY();
				r
						.showToolTipWindow(n, n.innerHTML_str,
								n.toolTipWindowMaxWidth)
			}
		};
		...
		r.showOrHideMarkers = function() {
			...
			for (var s = 0; s < r.totalMarkers; s++) {
				...
				if (!e.isActive_bl)
					e.hide();
				if (e.isActive_bl
						&& r.showMarkersWithAlphaForChromeFirstTime_bl) {
					e.showOnChromeOnce()
				}
			}
		...
		r.positionMarkers = function(e) {
			...
			for (var n = 0; n < r.totalMarkers; n++) {
				t = r.markers_ar[n];
				if (t.isActive_bl) {
					t.finalX = r.finalX + t.offsetX
							+ Math.round(t.originalX * r.currentScale);
					t.finalY = r.finalY + t.offsetY
							+ Math.round(t.originalY * r.currentScale);
					if (e) {
		...
		r.setupMarkersToolTip = function() {
			...
			r.markersToolTip_do = new FWDMarkerToolTip(r.toolTipLeft_img,
					r.toolTipPointer_img, r.buttonToolTipLeft_str,
					r.buttonToolTipMiddle_str, r.buttonToolTipRight_str,
					r.buttonToolTipFontColor_str,
					r.buttonToolTipTopPointer_str,
					r.buttonToolTipBottomPointer_str)
		};
		r.setupMarkersToolTipWindow = function() {
			FWDMarkerWindowToolTip.setPrototype();
			r.markersToolTipWindow_do = new FWDMarkerWindowToolTip(r,
					r.toolTipPointer_img, r.buttonToolTipTopPointer_str,
					r.buttonToolTipBottomPointer_str);
		...
		r.showMarkerToolTip = function(e, t) {
			...
			r.showMarkerToolTipId_to = setTimeout(
					function() {
						if (!r.markersToolTip_do.isShowed_bl)
							return;
						n = parseInt(e.finalX + (e.width - r.markersToolTip_do.totalWidth) / 2);
						i = e.finalY - r.markersToolTip_do.totalHeight
								- r.markerToolTipOffsetY;
						if (i < 0) {
							i = e.finalY + e.height
									+ r.markersToolTip_do.pointerHeight
									+ r.markerToolTipOffsetY;
							r.markersToolTip_do.pointerUp_sdo.setVisible(true);
							r.markersToolTip_do.pointerDown_sdo
									.setVisible(false);
						...
						if (n < 0) {
							o = n;
							n = 0
						} else if (r.stageWidth - n
								- r.markersToolTip_do.totalWidth < 0) {
							o = -(r.stageWidth - n - r.markersToolTip_do.totalWidth);
							n = n + r.stageWidth - n
									- r.markersToolTip_do.totalWidth
						}
		...
		r.showToolTipWindow = function(e, t, n) {
			if (r.markersToolTipWindow_do.toolTipWindowId == e.toolTipWindowId)
				return;
			var i;
			var s;
			var o = r.getX();
			...
			r.showToolTipWindoId_to = setTimeout(
					function() {
						i = parseInt(e.finalX
								+ (e.width - r.markersToolTipWindow_do.totalWidth)
								/ 2);
						if (e.finalY < r.stageHeight / 2) {
							s = e.finalY + e.height
									+ r.markersToolTipWindow_do.pointerHeight
									+ r.markerToolTipOffsetY;
							r.markersToolTipWindow_do.pointerUp_sdo
									.setVisible(true);
							r.markersToolTipWindow_do.pointerDown_sdo
									.setVisible(false);
							a = FWDMarkerWindowToolTip.POINTER_UP
						} else {
							s = e.finalY
									- r.markersToolTipWindow_do.totalHeight
									- r.markerToolTipOffsetY;
							r.markersToolTipWindow_do.pointerUp_sdo
									.setVisible(false);
							r.markersToolTipWindow_do.pointerDown_sdo
						...
						if (i < 0) {
							u = i;
							i = 0
						} else if (r.stageWidth - i
								- r.markersToolTipWindow_do.totalWidth < 0) {
							u = -(r.stageWidth - i - r.markersToolTipWindow_do.totalWidth);
							i = i + r.stageWidth - i
									- r.markersToolTipWindow_do.totalWidth
						}
		...
		r.toolTipWindowAddEventsToSetGlobalXAndGlobalY = function() {
			if (r.isMobile_bl) {
				r.addHideToolTipWindowTestWithDelayId_to = setTimeout(
						function() {
							if (r.hasPointerEvent_bl) {
								window.addEventListener("MSPointerDown",
										r.hideToolTipWindowTest);
								window.addEventListener("MSPointerMove",
										r.hideToolTipWindowTest)
							} else {
				...
				if (window.addEventListener) {
					...
					document
							.attachEvent("onmousemove", r.hideToolTipWindowTest)
				}
			}
		};
		r.hideToolTipWindowTest = function(e) {
			...
			r.globalX = t.screenX;
			r.globalY = t.screenY;
			if (e.touches || e.pointerType != e.MSPOINTER_TYPE_MOUSE)
				r.hideToolTipWindowWithDelay()
		};
		r.hideToolTipWindowWithDelay = function(e) {
			if (!FWDUtils.hitTest(r.markersToolTipWindow_do.screen, r.globalX,
					r.globalY)
					&& !FWDUtils.hitTest(r.curMarker_do.screen, r.globalX,
							r.globalY)) {
				r.hideToolTipWindow();
				if (r.isMobile_bl) {
		...
		r.showMarkersInfoPosition = function(e) {
			...
			var f = s + 10;
			var l = o + 10;
			r.markersPositionInfo_sdo.setInnerHTML("Image nr:"
					+ "<font color='#FF0000'>" + (r.curId + 1) + "</font>"
					+ "<br>x:" + "<font color='#FF0000'>" + u + "</font>"
					+ " y:" + "<font color='#FF0000'>" + a + "</font>");
		...
		r.zoomInOrOutWithScrollBar = function(e) {
			r.currentScale = e * (r.zoomFactor - r.smallestPossibleScale)
		...
		r.dispatchScrollBarUpdate = function(t, n) {
			if (!r.disablePanOrRotate_bl || n) {
				r.dispatchEvent(e.SCROLL_BAR_UPDATE, {
					percent : (r.currentScale - r.smallestPossibleScale)
		...
		r.updateNavigator = function(t) {
			if (!r.isNavigatorShowed_bl)
				return;
			r.dispatchEvent(e.UPDATE_NAVIGATOR,
					{
						percentX : Math.abs(r.finalX
								/ (r.finalWidth - r.stageWidth)),
						percentY : Math.abs(r.finalY
								/ (r.finalHeight - r.stageHeight)),
		...
		r.cleanMainEvents = function() {
			...
			if (r.isMobile_bl) {
				r.dumy_sdo.screen.removeEventListener("touchstart",
						r.panStartHandler);
				r.dumy_sdo.screen.removeEventListener("MSPointerDown",
						r.panStartHandler);
				window.removeEventListener("touchmove", r.panMoveHandler);
				window.removeEventListener("touchend", r.panEndHandler);
				...
				window.removeEventListener("MSPointerMove",
						r.hideToolTipWindowTest);
				r.screen.removeEventListener("gesturestart",
						r.gestureStartHandler);
				r.screen.removeEventListener("gesturechange",
						r.gestureChangeHandler)
			} else {
				if (window.removeEventListener) {
					r.dumy_sdo.screen.removeEventListener("mousedown",
							r.panStartHandler);
					window.removeEventListener("mousemove", r.panMoveHandler);
					window.removeEventListener("mouseup", r.panEndHandler);
					r.dumy_sdo.screen.removeEventListener("mousedown",
					...
					window
							.removeEventListener("mousemove",
									r.rotateMoveHandler);
					window.removeEventListener("mouseup", r.rotateEndHandler);
					r.dumy_sdo.screen.removeEventListener("mousewheel",
							r.mouseWheelHandler);
					r.dumy_sdo.screen.removeEventListener("DOMMouseScroll",
							r.mouseWheelHandler);
					window.removeEventListener("mousemove",
							r.hideToolTipWindowTest);
					window.removeEventListener("mousemove",
					...
					document.detachEvent("onmousemove", r.panMoveHandler);
					document.detachEvent("onmouseup", r.panEndHandler);
					r.dumy_sdo.screen.detachEvent("onmousedown",
							r.panStartHandler);
					r.dumy_sdo.screen.detachEvent("onmousedown",
							r.rotateStartHandler);
					document.detachEvent("onmousemove", r.rotateMoveHandler);
					document.detachEvent("onmouseup", r.rotateEndHandler);
					r.dumy_sdo.screen.detachEvent("onmousewheel",
							r.mouseWheelHandler);
					document
							.detachEvent("onmousemove", r.hideToolTipWindowTest);
					document.detachEvent("onmousemove",
							r.showMarkersInfoPosition);
...
(function(e) {
	var t = function(n, r, i, s, o, u) {
		...
		this.setupMainContainers = function() {
			...
			if (a.isMobile_bl && a.hasPointerEvent_bl)
			...
			if (a.lightBoxWidth > e.w) {
				...
				a.finalLightBoxHeight = parseInt(a.lightBoxHeight
						* (e.w / a.lightBoxWidth))
			} else {
		...
		this.setupCloseButton = function(t, n) {
			...
			a.closeButton_do.addListener(FWDSimpleButton.MOUSE_DOWN,
					a.closeButtonOnStartHandler);
			a.addChild(a.closeButton_do);
			var i = parseInt((r.w + a.finalLightBoxWidth) / 2
					- a.closeButton_do.totalWidth / 2);
			var s = parseInt((r.h - a.finalLightBoxHeight) / 2
					- a.closeButton_do.totalHeight / 2);
		...
		this.closeButtonOnStartHandler = function(e) {
			...
			a.lighboxAnimDoneId_to = setTimeout(a.lighboxHideAnimationDone,
					1600);
...
(function(e) {
	var t = function(n, r, i, s, o, u, a, f) {
		...
		l.init = function() {
			...
			if (l.type_str == "tooltip" || !l.toolTipLabel_str)
				l.hasToolTip_bl = false;
		...
		f.setLabel = function(e) {
			...
			setTimeout(
					function() {
						...
						f.right_sdo.setX(f.text_sdo.screen.offsetWidth
								+ f.marginWidth);
						f.totalWidth = f.marginWidth * 2
								+ f.text_sdo.screen.offsetWidth
					}, 79)
		};
		...
		.push(function() {
			_gsDefine(
					...
					function(e, t, n) {
						...
						i.render = function(e, t, n) {
							var r = !this._dirty ? this._totalDuration : this
									.totalDuration(), i = this._time, o = this._totalTime, u = this._cycle, a, f, l;
							if (e >= r) {
								this._totalTime = r;
								this._cycle = this._repeat;
								if (this._yoyo && (this._cycle & 1) !== 0) {
									this._time = 0;
									this.ratio = this._ease._calcEnd ? this._ease
											.getRatio(0)
											: 0
								} else {
								...
								if (this._repeat !== 0) {
									...
									this._time = this._totalTime - this._cycle
											* c;
									if (this._yoyo)
										if ((this._cycle & 1) !== 0) {
											this._time = this._duration
								...
								if (this._easeType) {
									var h = this._time / this._duration, p = this._easeType, d = this._easePower;
									if (p === 1 || p === 3 && h >= .5) {
										h = 1 - h
									}
									if (p === 3) {
									...
									if (this._totalTime !== 0
										...
										if (!t) {
											this.vars.onStart.apply(
													this.vars.onStartScope
															|| this,
													this.vars.onStartParams
															|| s)
										}
							l = this._firstPT;
							while (l) {
									...
									if (!this._gc)
										if (this.vars.onRepeat) {
											this.vars.onRepeat.apply(
													this.vars.onRepeatScope
															|| this,
													this.vars.onRepeatParams
															|| s)
										}
							if (f)
								if (!this._gc) {
						...
						r.staggerTo = r.allTo = function(e, t, n, i, s, o, u) {
							i = i || 0;
							var a = [], f = e.length, l = n.delay || 0, c, h, p;
							for (h = 0; h < f; h++) {
								c = {};
								for (p in n) {
									c[p] = n[p]
						...
						r.staggerFrom = r.allFrom = function(e, t, n, i, s, o,
								u) {
							n.runBackwards = true;
							if (n.immediateRender != false) {
								n.immediateRender = true
						...
						r.staggerFromTo = r.allFromTo = function(e, t, n, i, s,
								o, u, a) {
							i.startAt = n;
							if (n.immediateRender) {
								i.immediateRender = true
						...
						r.killAll = function(e, n, r, i) {
							...
							var s = u(i != false), o = s.length, a = n && r
									&& i, f, l, c;
							for (c = 0; c < o; c++) {
								l = s[c];
								if (a || l instanceof t
										|| (f = l.target === l.vars.onComplete)
										&& r || n && !f) {
									if (e) {
						...
						r.killChildTweensOf = function(e, t) {
							...
							var i = n._tweenLookup, s = [], o, u, a, f, l;
							for (a in i) {
						...
						var a = function(e, n, r, i) {
							...
							var s = u(i), o = n && r && i, a = s.length, f, l;
							while (--a > -1) {
								l = s[a];
								if (o || l instanceof t
										|| (f = l.target === l.vars.onComplete)
						...
						i.progress = function(e) {
							return !arguments.length ? this._time	/ this.duration() : this.totalTime(this
									.duration()
									* e + this._cycle * this._duration, false)
						};
						i.totalProgress = function(e) {
							return !arguments.length ? this._totalTime	/ this.totalDuration() : this.totalTime(
									this.totalDuration() * e, false)
						};
						i.time = function(e, t) {
							if (!arguments.length) {
								return this._time
							...
							if (this._yoyo && (this._cycle & 1) !== 0) {
								e = this._duration - e + this._cycle
						...
						i.totalDuration = function(e) {
							if (!arguments.length) {
								if (this._dirty) {
									this._totalDuration = this._repeat === -1 ? 999999999999
											: this._duration
													* (this._repeat + 1)
													+ this._repeatDelay
													* this._repeat;
							...
							return this._repeat == -1 ? this : this
									.duration((e - this._repeat
											* this._repeatDelay)	/ (this._repeat + 1))
						};
						i.repeat = function(e) {
							if (!arguments.length) {
								return this._repeat
					...
					function(e, t, n) {
						...
						var r = function(e) {
							...
							if (this.vars.tweens instanceof Array) {
								this.insertMultiple(this.vars.tweens, 0,
										this.vars.align || "normal",
										this.vars.stagger || 0)
							}
						}, i = [ "onStartParams", "onUpdateParams",
								"onCompleteParams", "onReverseCompleteParams",
								"onRepeatParams" ], s = [], o = function(e) {
							var t = {}, n;
							for (n in e) {
								t[n] = e[n]
							}
						...
						u.to = function(e, t, r, i, s) {
							return this.insert(new n(e, t, r), this
									._parseTimeOrLabel(s)
									+ (i || 0))
						};
						u.from = function(e, t, r, i, s) {
							return this.insert(n.from(e, t, r), this
									._parseTimeOrLabel(s)
									+ (i || 0))
						};
						u.fromTo = function(e, t, r, i, s, o) {
							return this.insert(n.fromTo(e, t, r, i), this
									._parseTimeOrLabel(o)
									+ (s || 0))
						};
						u.staggerTo = function(e, t, i, s, u, a, f, l, c) {
							...
							return this.insert(h, this._parseTimeOrLabel(a)
									+ (u || 0))
						};
						...
						u.call = function(e, t, r, i, s) {
							return this.insert(n.delayedCall(0, e, t, r), this
									._parseTimeOrLabel(s)
									+ (i || 0))
						};
						u.set = function(e, t, r, i) {
							t.immediateRender = false;
							return this.insert(new n(e, 0, t), this
									._parseTimeOrLabel(i)
									+ (r || 0))
						};
						r.exportRoot = function(e, t) {
							...
							while (o) {
								u = o._next;
								if (!t
										|| !(o instanceof n && o.target == o.vars.onComplete)) {
						...
						u.insert = function(r, i) {
							if (r instanceof e) {
								...
								return this.addLabel(r, this._parseTimeOrLabel(
										i || 0, true))
							...
							t.prototype.insert.call(this, r, this
									._parseTimeOrLabel(i || 0, true));
							if (this._gc)
								if (!this._paused)
									if (this._time === this._duration)
						...
						u.insertMultiple = function(e, t, n, i) {
							n = n || "normal";
							i = i || 0;
							var s, o, u = this._parseTimeOrLabel(t || 0, true), a = e.length;
							for (s = 0; s < a; s++) {
						...
						u.appendMultiple = function(e, t, n, r) {
							return this.insertMultiple(e, this.duration()
									+ (t || 0), n, r)
						};
						...
						u.getLabelTime = function(e) {
							return this._labels[e] != null ? this._labels[e]
									: -1
						};
						...
						u.seek = function(e, t) {
							return this.totalTime(this._parseTimeOrLabel(e,
									false), t != false)
						};
						u.stop = function() {
						...
						u.render = function(e, t, n) {
							...
							var r = !this._dirty ? this._totalDuration : this
									.totalDuration(), i = this._time, o = this._startTime, u = this._timeScale, a = this._paused, f, l, c, h;
							if (e >= r) {
							...
							if (this._time > i) {
								...
								while (f) {
									...
									if (this._paused && !a) {
										break
											...
											|| f._startTime <= this._time
											&& !f._paused && !f._gc) {
										if (!f._reversed) {
											f.render((e - f._startTime)
													* f._timeScale, t, false)
										} else {
											f
													.render(
															(!f._dirty ? f._totalDuration
																	: f
																			.totalDuration())
																	- (e - f._startTime)
																	* f._timeScale,
								...
								while (f) {
									...
									if (this._paused && !a) {
										break
									} else if (f._active || f._startTime <= i
											&& !f._paused && !f._gc) {
										if (!f._reversed) {
											f.render((e - f._startTime)
													* f._timeScale, t, false)
						...
						u._kill = function(e, t) {
							...
							var n = t == null ? this.getChildren(true, true,
									false) : this.getTweensOf(t), r = n.length, i = false;
							while (--r > -1) {
								if (n[r]._kill(e, t)) {
									i = true
								}
						...
						u.totalDuration = function(e) {
							if (!arguments.length) {
								if (this._dirty) {
									var t = 0, n = this._first, r = -999999999999, i, s;
									while (n) {
										i = n._next;
										if (n._startTime < r
												&& this._sortChildren) {
											this.insert(n, n._startTime
													- n._delay)
										} else {
											r = n._startTime
										}
										if (n._startTime < 0) {
											t -= n._startTime;
											this.shiftChildren(-n._startTime,
													false, -9999999999)
										}
										s = n._startTime
												+ (!n._dirty ? n._totalDuration
														: n.totalDuration())	/ n._timeScale;
										if (s > t) {
											t = s
										}
										n = i
						...
						u.rawTime = function() {
							return this._paused || this._totalTime !== 0
									&& this._totalTime !== this._totalDuration ? this._totalTime
					...
					function(e, t, n) {
						...
						u.removeCallback = function(e, t) {
							if (t == null) {
								...
								var n = this.getTweensOf(e, false), r = n.length, i = this
										._parseTimeOrLabel(t, false);
								while (--r > -1) {
									if (n[r]._startTime === i) {
						...
						u.tweenTo = function(e, n) {
							...
							u = new t(this, Math.abs(Number(r.time)
									- this._time)	/ this._timeScale || .001, r);
							r.onStart = function() {
								u.target.paused(true);
								if (u.vars.time != u.target.time()) {
									u.duration(Math.abs(u.vars.time
											- u.target.time())	/ u.target._timeScale)
								}
								if (n.onStart) {
									n.onStart.apply(n.onStartScope || u,
											n.onStartParams || i)
								}
							};
							return u
						...
						u.tweenFromTo = function(e, t, n) {
							...
							return r.duration(Math.abs(r.vars.time
									- r.vars.startAt.time)	/ this._timeScale || .001)
						};
						u.render = function(e, t, n) {
							if (this._gc) {
								this._enabled(true, false)
							...
							this._active = !this._paused;
							var r = !this._dirty ? this._totalDuration : this
									.totalDuration(), s = this._time, o = this._totalTime, u = this._startTime, a = this._timeScale, f = this._rawPrevTime, l = this._paused, c = this._cycle, h, p, d, v, m;
							if (e >= r) {
								if (!this._locked) {
									this._totalTime = r;
									this._cycle = this._repeat
							...
							if (this._cycle !== c)
								if (!this._locked) {
									var y = this._yoyo && (c & 1) !== 0, b = y === (this._yoyo && (this._cycle & 1) !== 0), w = this._totalTime, E = this._cycle, S = this._rawPrevTime, x = this._time;
							...
							if (this._time > s) {
								...
								while (h) {
									...
									if (this._paused && !l) {
										break
											...
											|| h._startTime <= this._time
											&& !h._paused && !h._gc) {
										if (!h._reversed) {
											h.render((e - h._startTime)
													* h._timeScale, t, false)
										} else {
											h
													.render(
															(!h._dirty ? h._totalDuration
																	: h
																			.totalDuration())
																	- (e - h._startTime)
																	* h._timeScale,
								...
								while (h) {
									...
									if (this._paused && !l) {
										break
									} else if (h._active || h._startTime <= s
											&& !h._paused && !h._gc) {
										if (!h._reversed) {
											h.render((e - h._startTime)
													* h._timeScale, t, false)
							...
							if (this._onUpdate)
								if (!t) {
									this._onUpdate.apply(
											this.vars.onUpdateScope || this,
											this.vars.onUpdateParams || i)
								}
							if (m)
								if (!this._locked)
									if (!this._gc)
										if (u === this._startTime
												|| a != this._timeScale)
											if (this._time === 0
													|| r >= this
															.totalDuration()) {
						...
						u.progress = function(e) {
							return !arguments.length ? this._time
									/ this.duration() : this.totalTime(this
									.duration()
									* e + this._cycle * this._duration, false)
						};
						u.totalProgress = function(e) {
							return !arguments.length ? this._totalTime
									/ this.totalDuration() : this.totalTime(
									this.totalDuration() * e, false)
						};
			...
			_gsDefine(
					...
					function(e) {
						var t = function(t, n) {
							...
							this._func = {};
							this._round = {}
						}, n = t.prototype = new e("bezier", 1), i = 180 / Math.PI, s = [], o = [], u = [], f = {}, c = function(
								t, n, r, i) {
							this.a = t;
							this.b = n;
							this.c = r;
							...
							this.ca = r - t;
							this.ba = n - t
						}, h = ",x,y,z,left,top,right,bottom,marginTop,marginLeft,marginRight,marginBottom,paddingLeft,paddingTop,paddingRight,paddingBottom,backgroundPosition,backgroundPosition_y,", p = t.bezierThrough = function(
								e, t, n, i, c, p) {
							var d = {}, g = [], y, b;
							...
							t = t || "soft";
							var r = {}, i = t === "cubic" ? 3 : 2, s = t === "soft", o = [], u, a, f, l, h, p, d, v, m, g, y;
							if (s && n) {
								e = [ n ].concat(e)
							}
							...
							var a = e.length - 1, f = 0, l = e[0].a, c, h, p, d, v, m, y, b, w, E, S, x, T;
							for (c = 0; c < a; c++) {
								v = e[f];
								h = v.a;
								p = v.d;
							...
							var i = {
								...
								c : r
							}, a = (e + t) / 2, f = (t + n) / 2, l = (n + r) / 2, c = (a + f) / 2, h = (f + l) / 2, p = (h - c) / 8;
							i.b = a + (e - a) / 4;
							s.b = c + p;
							i.c = s.a = (i.b + s.b) / 2;
							s.c = o.a = (c + h) / 2;
						...
						n._onInitTween = function(e, t, n) {
							...
							this._props = [];
							this._timeRes = t.timeResolution == null ? 6
									: parseInt(t.timeResolution);
							var r = t.values || [], i = {}, s = r[0], o = t.autoRotate
									|| n.vars.orientToBezier, u, a, f, l, c;
							this._autoRotate = o ? o instanceof Array ? o : [ [
									"x", "y", "rotation",
									o === true ? 0 : Number(o) || 0 ] ] : null;
							for (u in s) {
								this._props.push(u)
							}
							...
							while (--f > -1) {
								...
								i[u] = !a ? parseFloat(e[u])
										: e[u.indexOf("set")
												|| typeof e["get" + u.substr(3)] !== "function" ? u
												: "get" + u.substr(3)]();
								if (!c)
									if (i[u] !== r[0][u]) {
										c = i
							...
							this._beziers = t.type !== "cubic"
									&& t.type !== "quadratic"
									&& t.type !== "soft" ? p(r,
									isNaN(t.curviness) ? 1 : t.curviness,
									false, t.type === "thruBasic", t.correlate,
									c) : d(r, t.type, i);
							...
							if (o = this._autoRotate) {
								...
								while (--f > -1) {
									for (l = 0; l < 3; l++) {
										u = o[f][l];
										this._func[u] = typeof e[u] === "function" ? e[u
												.indexOf("set")
												|| typeof e["get" + u.substr(3)] !== "function" ? u
												: "get" + u.substr(3)]
												: false
						...
						n.setRatio = function(e) {
							var t = this._segCount, n = this._func, r = this._target, s, o, u, a, f, l, c, h, p, d;
							if (!this._timeRes) {
								...
								l = (u + (e - this._s1) / (this._s2 - this._s1))
										* this._prec
							}
							o = 1 - l;
			...
			_gsDefine(
					...
					function(e, t) {
						...
						var i = /[^\d\-\.]/g, s = /(\d|\-|\+|=|#|\.)*/g, o = /(\d|\.)+/g, u = /opacity *= *([^)]*)/, a = /opacity:([^;]*)/, f = /([A-Z])/g, l = /-([a-z])/gi, c = function(
								e, t) {
							return t.toUpperCase()
						}, h = /(Left|Right|Width)/i, p = /(M11|M12|M21|M22)=[\d\-\.e]+/gi, d = /progid\:DXImageTransform\.Microsoft\.Matrix\(.+?\)/i, v = Math.PI / 180, m = 180 / Math.PI, g = {}, y = document, b = y
								.createElement("div"), w = navigator.userAgent, E, S, x, T, N = function() {
							var e = w.indexOf("Android"), t = y
									.createElement("div"), n;
							x = w.indexOf("Safari") !== -1
									&& w.indexOf("Chrome") === -1
									&& (e === -1 || Number(w.substr(e + 8, 1)) > 3);
							...
							if (!e || e === "") {
								...
								if (e.length === 4) {
									var t = e.charAt(1), n = e.charAt(2), r = e
											.charAt(3);
									e = "#" + t + t + n + n + r + r
								}
							...
							return u.test(typeof e === "string" ? e
									: (e.currentStyle ? e.currentStyle.filter
											: e.style.filter)
											|| "") ? parseFloat(RegExp.$1) / 100
									: 1
						}, L = y.defaultView ? y.defaultView.getComputedStyle
								: function(e, t) {
								}, A = function(e, t, n, r) {
							if (!N && t === "opacity") {
								return k(e)
								...
								e = n.getPropertyValue(t.replace(f, "-$1")
										.toLowerCase());
							...
							return null
						}, B = H("transform"), j = D + "transform", F = function(
								e, t, n) {
							var r = e._gsTransform, i;
							if (B) {
								i = A(e, j, t, true)
							} else if (e.currentStyle) {
								i = e.currentStyle.filter.match(p);
								i = i && i.length === 4 ? i[0].substr(4) + ","
										+ Number(i[2].substr(4)) + ","
										+ Number(i[1].substr(4)) + ","
										+ i[3].substr(4) + "," + (r ? r.x : 0)
										+ "," + (r ? r.y : 0) : null
							}
							var s = (i || "").replace(/[^\d\-\.e,]/g, "")
									.split(","), o = s.length >= 6, u = o ? Number(s[0])
									: 1, a = o ? Number(s[1]) : 0, f = o ? Number(s[2])
									: 0, l = o ? Number(s[3]) : 1, c = 1e-6, h = n ? r
									|| {
										skewY : 0
									}
									: {
							...
							h.rotation = u || a ? Math.atan2(a, u)
									: h.rotation || 0;
							h.skewX = f || l ? Math.atan2(f, l) + h.rotation
									: h.skewX || 0;
							if (Math.abs(h.skewX) > Math.PI / 2) {
								if (d) {
									h.scaleX *= -1;
									h.skewX += h.rotation <= 0 ? Math.PI
											: -Math.PI;
									h.rotation += h.rotation <= 0 ? Math.PI
											: -Math.PI
								} else {
									h.scaleY *= -1;
									h.skewX += h.skewX <= 0 ? Math.PI
											: -Math.PI
								}
							}
							if (h.rotation < c)
							...
							width : [ "Left", "Right" ],
							height : [ "Top", "Bottom" ]
						}, q = [ "marginLeft", "marginRight", "marginTop",
								"marginBottom" ], R = function(e, t, n) {
							var r = parseFloat(e === "width" ? t.offsetWidth
									: t.offsetHeight), i = I[e], s = i.length, n = n
									|| L(t, null);
							while (--s > -1) {
								r -= parseFloat(A(t, "padding" + i[s], n, true)) || 0;
								r -= parseFloat(A(t, "border" + i[s] + "Width",
										n, true)) || 0
							}
							return r
							...
							var s = h.test(t), o = e, u = b.style, a = n < 0;
							if (a) {
								n = -n
							}
							...
							if (r === "%" || r === "em" || !o.appendChild) {
								...
								u[s ? "borderLeftWidth" : "borderTopWidth"] = n
										+ r
							}
							o.appendChild(b);
							var f = parseFloat(b[s ? "offsetWidth"
									: "offsetHeight"]);
							o.removeChild(b);
							if (f === 0 && !i) {
								f = U(e, t, n, r, true)
							...
							t = t || {};
							var n = e.indexOf("left") !== -1 ? "0%" : e
									.indexOf("right") !== -1 ? "100%" : e
									.split(" ")[0], r = e.indexOf("top") !== -1 ? "0%"
									: e.indexOf("bottom") !== -1 ? "100%" : e
											.split(" ")[1];
							if (r == null) {
								r = "0"
							} else if (r === "center") {
							...
							return e == null ? t : typeof e === "string"
									&& e.indexOf("=") === 1 ? Number(e.split(
									"=").join(""))
									+ t : Number(e)
						}, X = function(e, t) {
							var n = e.indexOf("rad") === -1 ? v : 1, r = e
									.indexOf("=") === 1;
						...
						r._onInitTween = function(e, t, r) {
							...
							E = t.autoRound;
							var i = this._style = e.style, s = L(e, ""), o, u, f;
							if (S)
								if (i.zIndex === "") {
									f = A(e, "zIndex", s);
									if (f === "auto" || f === "") {
							...
							if (typeof t === "string") {
								...
								this._classData = {
									b : o,
									e : t.className.charAt(1) !== "=" ? t.className
											: t.className.charAt(0) === "+" ? e.className
													+ " "
													+ t.className.substr(2)
													: e.className.split(
															t.className
																	.substr(2))
															.join(""),
							...
							this
									._parseVars(t, e, s, t.suffixMap
											|| n.suffixMap);
							return true
						};
						r._parseVars = function(e, t, n, r) {
							var o = this._style, u, a, f, l, c, h, p, d, v, m, g, y;
							for (u in e) {
								a = e[u];
								if (u === "transform" || u === B) {
								...
								if (u === "color" || u === "fill"
									...
									c = C(l);
									h = C(a);
									f.e = f.i = (h.length > 3 ? "rgba("
											: "rgb(")
											+ h.join(",") + ")";
									f.b = (c.length > 3 ? "rgba(" : "rgb(")
											+ c.join(",") + ")";
									f.s = Number(c[0]);
									f.c = Number(h[0]) - f.s;
									f.gs = Number(c[1]);
						...
						r._parseTransform = function(e, t, n, r) {
							...
							var i = this._transform = F(e, n, true), s = this._style, o = 1e-6, u, a, f, l, c, h;
							if (typeof t === "object") {
								u = {
									scaleX : W(t.scaleX != null ? t.scaleX
											: t.scale, i.scaleX),
									scaleY : W(t.scaleY != null ? t.scaleY
											: t.scale, i.scaleY),
									x : W(t.x, i.x),
									y : W(t.y, i.y)
								};
								if (t.shortRotation != null) {
									u.rotation = typeof t.shortRotation === "number" ? t.shortRotation
											* v
											: X(t.shortRotation, i.rotation);
									var p = (u.rotation - i.rotation)
											% (Math.PI * 2);
									if (p !== p % Math.PI) {
										p += Math.PI * (p < 0 ? 2 : -2)
									}
									...
									u.rotation = t.rotation == null ? i.rotation
											: typeof t.rotation === "number" ? t.rotation
													* v
													: X(t.rotation, i.rotation)
								}
								u.skewX = t.skewX == null ? i.skewX
										: typeof t.skewX === "number" ? t.skewX
												* v : X(t.skewX, i.skewX);
								u.skewY = t.skewY == null ? i.skewY
										: typeof t.skewY === "number" ? t.skewY
												* v : X(t.skewY, i.skewY);
								...
								if (i[f] !== u[f] || g[f] != null)
									if (f !== "shortRotation")
										if (f !== "scale") {
											...
											this._overwriteProps.push("css_"
													+ f)
										}
							}
						};
						r._parseBezier = function(e, t, n, r) {
							...
							var i = e.values || [], s = i.length, o = [], u = this._bezier = {
								_pt : []
							}, a = u._proxy = {}, f = 0, l = 0, c = {}, h = s - 1, p = g, d = u._plugin = new window.com.greensock.plugins.BezierPlugin, v, m, y, b, w, E;
							for (m = 0; m < s; m++) {
								w = {};
							...
							if (e.autoRotate)
								if (!(e.autoRotate instanceof Array)) {
									m = e.autoRotate == true ? 0
											: Number(e.autoRotate) * Math.PI
													/ 180;
						...
						r.setRatio = function(e) {
							var t = this._firstPT, n = this._bezier, r = 1e-6, i, o, a;
							if (n) {
								n._plugin.setRatio(e);
								var f = n._pt, l = n._proxy;
								o = f.length;
								while (--o > -1) {
									t = f[o];
									t.s = l[t.p];
							...
							if (e === 1
								...
								while (t) {
									...
									if (!t.type) {
										...
										if (t.dup) {
											t.t.filter = t.t.filter
													|| "alpha(opacity=100)"
										}
										if (t.t.filter.indexOf("opacity") === -1) {
											t.t.filter += " alpha(opacity="
													+ (i * 100 >> 0) + ")"
										} else {
											t.t.filter = t.t.filter
													.replace(u, "opacity="
							...
							if (this._transform) {
								...
								if (B && !t.rotation && !t.skewX) {
									this._style[B] = (t.x || t.y ? "translate("
											+ t.x + "px," + t.y + "px) " : "")
											+ (t.scaleX !== 1 || t.scaleY !== 1 ? "scale("
													+ t.scaleX
													+ ","
													+ t.scaleY
													+ ")"
									...
									var c = B ? t.rotation : -t.rotation, h = B ? c
											- t.skewX
											: c + t.skewX, p = Math.cos(c)
											* t.scaleX, v = Math.sin(c)
											* t.scaleX, m = Math.sin(h)
											* -t.scaleY, g = Math.cos(h)
											* t.scaleY, y;
									if (p < r)
										if (p > -r) {
											p = 0
									...
									if (B) {
										...
										var b = y.filter;
										this._style.filter = "";
										var w = this._target.offsetWidth, E = this._target.offsetHeight, S = y.position !== "absolute", x = "progid:DXImageTransform.Microsoft.Matrix(M11="
												+ p
												+ ", M12="
												+ v
												+ ", M21="
												+ m + ", M22=" + g, N = t.x, C = t.y, k, L;
										if (t.ox != null) {
											k = (t.oxp ? w * t.ox * .01 : t.ox)
													- w / 2;
											L = (t.oyp ? E * t.oy * .01 : t.oy)
													- E / 2;
											N = k - (k * p + L * v) + t.x;
											C = L - (k * m + L * g) + t.y
										}
										...
										if (b
												.indexOf("DXImageTransform.Microsoft.Matrix(") !== -1) {
											this._style.filter = b
													.replace(d, x)
										} else {
			...
			_gsDefine(
					...
					function(e) {
						...
						n._onInitAllProps = function() {
							var e = this._tween, t = e.vars.roundProps instanceof Array ? e.vars.roundProps
									: e.vars.roundProps.split(","), n = t.length, r = {}, i = e._propLookup.roundProps, s, o, u;
							while (--n > -1) {
								r[t[n]] = 1
							}
							n = t.length;
			...
			_gsDefine("easing.Back", [ "easing.Ease" ], function(e) {
				var t = window.com.greensock, n = t._class, r = function(t, r) {
					var i = n("easing." + t, function() {
					}, true), s = i.prototype = new e;
					s.constructor = i;
					s.getRatio = r;
					return i
				}, i = function(t, r) {
					...
					return (e = e - 1) * e * ((this._p1 + 1) * e + this._p1)
							+ 1
				}), o = i("BackIn", function(e) {
					return e * e * ((this._p1 + 1) * e - this._p1)
				}), u = i("BackInOut", function(e) {
					return (e *= 2) < 1 ? .5 * e * e
							* ((this._p2 + 1) * e - this._p2) : .5 * ((e -= 2)
							* e * ((this._p2 + 1) * e + this._p2) + 2)
					...
					return (e *= 2) < 1 ? -.5 * (Math.sqrt(1 - e * e) - 1)
							: .5 * (Math.sqrt(1 - (e -= 2) * e) + 1)
				}), d = Math.PI * 2, v = function(t, r, i) {
					var s = n("easing." + t, function(e, t) {
						this._p1 = e || 1;
						this._p2 = t || i;
						this._p3 = this._p2 / d
								* (Math.asin(1 / this._p1) || 0)
					}, true), o = s.prototype = new e;
					o.constructor = s;
					o.getRatio = r;
					...
					return this._p1 * Math.pow(2, -10 * e)
							* Math.sin((e - this._p3) * d / this._p2) + 1
				}, .3), g = v("ElasticIn", function(e) {
					return -(this._p1 * Math.pow(2, 10 * (e -= 1)) * Math
							.sin((e - this._p3) * d / this._p2))
				}, .3), y = v("ElasticInOut", function(e) {
					return (e *= 2) < 1 ? -.5 * this._p1
							* Math.pow(2, 10 * (e -= 1))
							* Math.sin((e - this._p3) * d / this._p2)
							: this._p1 * Math.pow(2, -10 * (e -= 1))
									* Math.sin((e - this._p3) * d / this._p2)
									* .5 + 1
				}, .45), b = r("ExpoOut", function(e) {
					return 1 - Math.pow(2, -10 * e)
				}), w = r("ExpoIn", function(e) {
					return Math.pow(2, 10 * (e - 1)) - .001
				}), E = r("ExpoInOut", function(e) {
					return (e *= 2) < 1 ? .5 * Math.pow(2, 10 * (e - 1))
							: .5 * (2 - Math.pow(2, -10 * (e - 1)))
				}), S = Math.PI / 2, x = r("SineOut", function(e) {
					return Math.sin(e * S)
				...
				}, true), k = C.prototype = new e;
				k.constructor = C;
				k.getRatio = function(e) {
					var t = e + (.5 - e) * this._p;
					if (e < this._p1) {
						return this._calcEnd ? 1 - (e = 1 - e / this._p1) * e
								: t - (e = 1 - e / this._p1) * e * e * e * t
					} else if (e > this._p3) {
						return this._calcEnd ? 1
								- (e = (e - this._p3) / this._p1) * e : t
								+ (e - t) * (e = (e - this._p3) / this._p1) * e
								* e * e
					}
...
(function(e) {
	...
	var t = function(t) {
		...
		return r
	}, n = t("com.greensock"), r, i, s, o, u, a, f = {}, l = function(n, r, i,
			s) {
		this.sc = f[n] ? f[n].sc : [];
		f[n] = this;
		this.gsClass = null;
		...
		this.check = function(r) {
			...
			if (c === 0 && i) {
				var p = ("com.greensock." + n).split("."), d = p.pop(), v = t(p
						.join("."))[d] = this.gsClass = i.apply(i, u);
				if (s) {
					(e.GreenSockGlobals || e)[d] = v;
					if (typeof define === "function" && define.amd) {
						define((e.GreenSockAMDPath ? e.GreenSockAMDPath + "/"
								: "")
								+ n.split(".").join("/"), [], function() {
							return v
						})
	...
	var h = [ 0, 0, 1, 1 ], p = [], d = c("easing.Ease", function(e, t, n, r) {
		this._func = e;
		this._type = n || 0;
		this._power = r || 0;
	...
	u.getRatio = function(e) {
		if (this._func) {
			...
			var t = this._type, n = this._power, r = t === 1 ? 1 - e
					: t === 2 ? e : e < .5 ? e * 2 : (1 - e) * 2;
			if (n === 1) {
				r *= r
			} else if (n === 2) {
	...
	i = r.length;
	while (--i > -1) {
		s = c("easing." + r[i], function() {
		}, true);
		o = c("easing.Power" + i, function() {
		}, true);
	...
	u.dispatchEvent = function(e) {
		...
		if (t) {
			var n = t.length, r, i = this._eventTarget;
			while (--n > -1) {
				r = t[n];
				if (r.up) {
					r.c.call(r.s || i, {
	...
	var v = e.requestAnimationFrame, m = e.cancelAnimationFrame, g = Date.now
			|| function() {
	...
	c("Ticker", function(t, n) {
		this.time = 0;
		this.frame = 0;
		var r = this, i = g(), s = n !== false, o, u, a, f, l;
		this.tick = function() {
			r.time = (g() - i) / 1e3;
			if (!o || r.time >= l) {
				r.frame++;
	...
	u._enabled = function(e, t) {
		this._gc = !e;
		this._active = e && !this._paused && this._totalTime > 0
	...
	u.duration = function(e) {
		...
		if (this._timeline.smoothChildTiming)
			if (this._active)
				if (e != 0) {
					this
							.totalTime(this._totalTime * (e / this._duration),
									true)
				}
		return this
	};
	...
	u.totalTime = function(e, t) {
		...
		if (this._timeline) {
			...
			if (this._timeline.smoothChildTiming) {
				...
				this._startTime = (this._paused ? this._pauseTime
						: this._timeline._time)
						- (!this._reversed ? e : this._totalDuration - e)
						/ this._timeScale;
	...
	u.timeScale = function(e) {
		...
		if (this._timeline && this._timeline.smoothChildTiming) {
			var t = this._pauseTime || this._pauseTime == 0 ? this._pauseTime
		...
		if (e != this._paused)
			if (this._timeline) {
				if (!e && this._timeline.smoothChildTiming) {
					this._startTime += this._timeline.rawTime()
							- this._pauseTime;
					this._uncache(false)
				}
				this._pauseTime = e ? this._timeline.rawTime() : null;
				this._paused = e;
				this._active = !this._paused && this._totalTime > 0
						&& this._totalTime < this._totalDuration
			}
		if (this._gc)
			if (!e) {
	...
	u.insert = function(e, t) {
		...
		if (e._paused)
			if (this !== e._timeline) {
				e._pauseTime = e._startTime + (this.rawTime() - e._startTime)
						/ e._timeScale
			}
		if (e.timeline) {
		...
		while (r) {
			...
			if (r._active || e >= r._startTime && !r._paused) {
				if (!r._reversed) {
					...
					r.render((!r._dirty ? r._totalDuration : r.totalDuration())
							- (e - r._startTime) * r._timeScale, t, false)
				}
			}
			r = i
		}
	...
	var E = c(
			...
			function(e, t, n) {
				...
				this.target = e;
				this._overwrite = this.vars.overwrite == null ? C[E.defaultOverwrite]
						: typeof this.vars.overwrite === "number" ? this.vars.overwrite >> 0
								: C[this.vars.overwrite];
				var r, i, s;
				if ((e instanceof Array || e.jquery)
						&& typeof e[0] === "object") {
					...
					for (i = 0; i < this._targets.length; i++) {
						...
						if (s.jquery) {
							...
							this._targets = this._targets.concat(s.constructor
									.makeArray(s));
							continue
						}
				...
				if (this.vars.immediateRender || t === 0 && this._delay === 0
	...
	E.ticker = b;
	var S = E._plugins = {}, x = E._tweenLookup = {}, T = 0, N = {
		ease : 1,
		delay : 1,
		overwrite : 1,
		onComplete : 1,
		...
		"true" : 1,
		"false" : 0
	}, k = y._rootFramesTimeline = new w, L = y._rootTimeline = new w;
	L._startTime = b.time;
	...
	var A = function(e, t, n) {
		...
		var f = t._startTime + 1e-10, l = [], c = 0, h;
		s = i.length;
		while (--s > -1) {
		...
		var n = e._timeline, r = n._timeScale, i = e._startTime;
		while (n._timeline) {
			i += n._startTime;
			r *= n._timeScale;
			if (n._paused) {
		...
		i /= r;
		return i > t ? i - t : !e._initted && i - t < 2e-10 ? 1e-10 : (i = i
				+ e.totalDuration() / e._timeScale / r) > t ? 0 : i - t - 1e-10
	};
	u._init = function() {
		...
		if (this.vars.ease instanceof d) {
			this._ease = this.vars.easeParams instanceof Array ? this.vars.ease.config
					.apply(this.vars.ease, this.vars.easeParams)
					: this.vars.ease
		...
		if (this._targets) {
			...
			while (--e > -1) {
				if (this._initProps(this._targets[e], this._propLookup[e] = {},
						this._siblings[e],
						this._overwrittenProps ? this._overwrittenProps[e]
								: null)) {
					t = true
				}
			}
		} else {
			t = this._initProps(this.target, this._propLookup, this._siblings,
	...
	u._initProps = function(e, t, n, r) {
		...
		for (i in this.vars) {
			if (N[i]) {
				if (i === "onStartParams" || i === "onUpdateParams"
						|| i === "onCompleteParams"
						|| i === "onReverseCompleteParams"
						|| i === "onRepeatParams")
					if (a = this.vars[i]) {
						s = a.length;
						while (--s > -1) {
					...
					&& (u = new S[i])._onInitTween(e, this.vars[i], this)) {
				this._firstPT = f = {
					_next : this._firstPT,
					t : u,
					p : "setRatio",
				...
				f.s = !f.f ? parseFloat(e[i]) : e[i.indexOf("set")
						|| typeof e["get" + i.substr(3)] !== "function" ? i
						: "get" + i.substr(3)]();
				f.c = typeof this.vars[i] === "number" ? this.vars[i] - f.s
						: typeof this.vars[i] === "string" ? parseFloat(this.vars[i]
								.split("=").join(""))
								: 0
			}
			if (f)
	...
	u.render = function(e, t, n) {
		...
		if (r === 0)
			if (this.vars.onStart)
				if (this._time !== 0 || this._duration === 0)
					if (!t) {
						this.vars.onStart.apply(this.vars.onStartScope || this,
		...
		if (this._onUpdate)
			if (!t) {
				this._onUpdate.apply(this.vars.onUpdateScope || this,
		...
		if (s)
			if (!this._gc) {
				...
				if (!t)
					if (this.vars[s]) {
						this.vars[s].apply(this.vars[s + "Scope"] || this,
								this.vars[s + "Params"] || p)
					}
			}
	};
	u._kill = function(e, t) {
	...
	E.killTweensOf = E.killDelayedCallsTo = function(e, t) {
		var n = E.getTweensOf(e), r = n.length;
		while (--r > -1) {
			n[r]._kill(t, e)
		}
	};
	...
	u._addTween = function(e, t, n, r, i, s) {
		var o;
		if (r != null
				&& (o = typeof r === "number" || r.charAt(1) !== "=" ? Number(r)
						- n
						: Number(r.split("=").join("")))) {
			this._firstPT = {
				_next : this._firstPT,
	...
	if (r = e._gsQueue) {
		...
		for (u in f) {
			if (!f[u].def) {
				console
						.log("Warning: TweenLite encountered missing dependency: com.greensock."
								+ u)
			}
		}
	}
...
(function(e) {
	var t = function(n, r) {
		...
		i.activate = function() {
			...
			if (FWDUtils.isIEAndLessThen9)
				i.handler_sdo.screen.onmousedown = function() {
					i.dispatchEvent(t.MOUSE_DOWN)
				}
		};
		i.resizeAndPosition = function() {
			if (n.stageWidth == i.stageWidth && n.stageHeight == i.stageHeight)
				return;
			i.stageWidth = n.stageWidth;
			i.stageHeight = n.stageHeight;
		...
		i.onHiderHide = function() {
			if (FWDUtils.hitTest(i.mainHolder_do.screen, i.hider.globalX,
					i.hider.globalY))
				i.hider.reset()
		};
		i.setupMainContiners = function() {
			...
			i.mainImagesHolder_do = new FWDDisplayObject("div", "absolute",
					"visible");
			...
			if (FWDUtils.isIE)
				i.handler_sdo.getStyle().background = "url('dumy')";
		...
		i.setupImagesSdos = function(e) {
			...
			if (e == 0)
				i.smallImage_sdo = i.iamgesSdo_ar[0]
		};
		i.updateImage = function(e) {
			if (i.smallImage_sdo)
				i.smallImage_sdo.setVisible(false);
		...
		i.addPannSupport = function() {
			i.handler_sdo.screen.style.cursor = "url(" + i.handMovePath_str
					+ "), default";
			if (i.isMobile_bl) {
				if (i.hasPointerEvent_bl) {
					i.handler_sdo.screen.addEventListener("MSPointerDown",
							i.panStartHandler)
				} else {
					i.handler_sdo.screen.addEventListener("touchstart",
							i.panStartHandler)
				}
			} else if (i.handler_sdo.screen.addEventListener) {
				i.handler_sdo.screen.addEventListener("mousedown",
						i.panStartHandler)
			} else if (i.handler_sdo.screen.attachEvent) {
				i.handler_sdo.screen.attachEvent("onmousedown",
						i.panStartHandler)
			}
		};
		i.panStartHandler = function(r) {
			...
			if (i.isMobile_bl) {
				...
				i.handler_sdo.screen.style.cursor = "url(" + i.handGrabPath_str
						+ "), default";
				i.screen.style.cursor = "url(" + i.handGrabPath_str
						+ "), default";
				if (e.addEventListener) {
		...
		i.panMoveHandler = function(e) {
			...
			i.finalX = Math.round(i.xPositionOnPress + n.screenX
					- i.lastPresedX);
			if (i.finalX < 1) {
				i.finalX = 1
			...
			i.handler_sdo.setX(i.finalX);
			i.finalY = Math.round(i.yPositionOnPress + n.screenY
					- i.lastPresedY);
			if (i.finalY < 1) {
				i.finalY = 1
		...
		i.hide = function(e) {
			if (!i.isShowed_bl)
				return;
			if (i.navigatorPosition_str == t.TOP_LEFT
					|| i.navigatorPosition_str == t.TOP_RIGHT) {
				if (e) {
					TweenMax.to(i.mainHolder_do, 1, {
					...
					|| i.navigatorPosition_str == t.BOTTOM_RIGHT) {
				if (e) {
					TweenMax.to(i.mainHolder_do, 1, {
						y : i.totalHeight + i.offsetY,
						ease : Expo.easeInOut
		...
		i.cleanMainEvents = function() {
			if (i.isMobile_bl) {
				i.handler_sdo.screen.removeEventListener("touchstart",
						i.panStartHandler);
				i.handler_sdo.screen.addEventListener("MSPointerDown",
						i.panStartHandler);
				e.removeEventListener("touchmove", i.panMoveHandler);
				...
				i.handler_sdo.screen.removeEventListener("mousedown",
						i.panStartHandler);
				e.removeEventListener("mousemove", i.panMoveHandler);
				e.removeEventListener("mouseup", i.panEndHandler)
			} else if (i.handler_sdo.screen.detachEvent) {
				i.handler_sdo.screen.detachEvent("onmousedown",
						i.panStartHandler);
				document.detachEvent("onmousemove", i.panMoveHandler);
				document.detachEvent("onmouseup", i.panEndHandler)
			}
...
(function(e) {
	var t = function(e, n, r, i, s, o, u) {
		...
		a.init = function() {
			a.setupMainContainers();
			if (FWDUtils.isMobile) {
				a.screen.addEventListener("touchstart",
						a.windowTouchStartHandler)
			}
		};
		...
		a.positionAndResize = function() {
			if (e.stageWidth == a.stageWidth && e.stageHeight == a.stageHeight)
				return;
			if (!a.allowResize_bl)
				return;
			...
			a.mainAnimHolder_do
					.setX(Math.round(a.stageWidth - a.segmentWidth) / 2);
			a.mainAnimHolder_do.setY(Math
					.round((a.stageHeight - a.segmentHeight) / 2) - 10);
		...
		a.update = function(e, t) {
			...
			a.text_do.setX(Math
					.round((a.segmentWidth - a.text_do.getWidth()) / 2))
		};
		a.show = function() {
		...
		a.destroy = function() {
			if (FWDUtils.isMobile) {
				a.screen.removeEventListener("touchstart",
						a.windowTouchStartHandler)
			}
			TweenMax.killTweensOf(a);
			TweenMax.killTweensOf(a.bk_do);
	...
	var t = function(e, n) {
		...
		r.onMouseOver = function(e) {
			if (!e.pointerType || e.pointerType == e.MSPOINTER_TYPE_MOUSE) {
				...
				if (r.isDisabled_bl || r.isSelectedFinal_bl)
					return;
		...
		r.destroy = function() {
			if (r.isMobile_bl) {
				if (r.hasPointerEvent_bl) {
					r.screen
							.removeEventListener("MSPointerDown", r.onMouseDown);
					r.screen.removeEventListener("MSPointerUp", r.onClick);
					r.screen
							.removeEventListener("MSPointerOver", r.onMouseOver);
...
(function(e) {
	var t = function(e, t, n) {
		...
		r.getTransformOrigin = function() {
			var e = [ "transformOrigin", "msTransformOrigin",
					"WebkitTransformOrigin", "MozTransformOrigin",
					"OTransformOrigin" ];
			var t;
			while (t = e.shift()) {
				if (typeof r.screen.style[t] !== "undefined") {
		...
		r.setMainProperties = function() {
			...
			if (r.opacityType == "opacity")
				r.isHtml5_bl = true;
			if (r.opacityType == "filter")
				r.screen.style.filter = "inherit";
		...
		r.setAlpha = function(e) {
			...
			if (r.opacityType == "opacity") {
				...
				r.screen.style.filter = "progid:DXImageTransform.Microsoft.Alpha(Opacity="
		...
		r.setX = function(e) {
			...
			if (r.hasTransform3d_bl) {
				r.screen.style[r.transform] = "translate3d(" + r.x + "px,"
						+ r.y + "px,0) scale(" + r.scale + "," + r.scale + ")"
			} else {
		...
		r.getWidth = function() {
			if (r.type == "div") {
				if (r.screen.offsetWidth != 0)
					return r.screen.offsetWidth;
				return r.w
			} else if (r.type == "img") {
				if (r.screen.offsetWidth != 0)
					return r.screen.offsetWidth;
		...
		r.getHeight = function() {
			if (r.type == "div") {
				if (r.screen.offsetHeight != 0)
					return r.screen.offsetHeight;
				return r.h
			} else if (r.type == "img") {
				if (r.screen.offsetHeight != 0)
					return r.screen.offsetHeight;
				if (r.screen.height != 0)
		...
		this.setScale = function(e) {
			...
			if (r.hasTransform2d_bl) {
				r.screen.style[r.transform] = "scale(" + r.scale + ","
						+ r.scale + ")"
			} else {
				r.screen.style[r.transform] = "translate3d(" + r.x + "px,"
						+ r.y + "px,0) scale(" + r.scale + "," + r.scale + ")"
		...
		r.setPositionAndScale = function(e, t, n) {
			...
			r.y = t;
			r.scale = n;
			r.screen.style[r.transform] = "translate3d(" + r.x + "px," + r.y
					+ "px,0) scale(" + r.scale + "," + r.scale + ")"
		};
		...
		r.addChild = function(e) {
			if (r.contains(e)) {
				r.children_ar
						.splice(FWDUtils.indexOfArray(r.children_ar, e), 1);
...
(function(e) {
	function n() {
		var e = [ "transform", "msTransform", "WebkitTransform",
				"MozTransform", "OTransform", "KhtmlTransform" ];
		var n;
		var r;
		while (n = e.shift()) {
	...
	t.hitTest = function(e, t, n) {
		...
		if (t >= i.left && t <= i.left + (i.right - i.left) && n >= i.top
				&& n <= i.top + (i.bottom - i.top))
			return true;
		return false
	};
	...
	t.getViewportMouseCoordinates = function(e) {
		...
		if (e.touches) {
			return {
				screenX : e.touches[0] == undefined ? e.touches.pageX - n.x
						: e.touches[0].pageX - n.x,
				screenY : e.touches[0] == undefined ? e.touches.pageY - n.y
						: e.touches[0].pageY - n.y
			}
		}
		return {
	...
	t.hasFullScreen = function() {
		return t.dumy.requestFullScreen || t.dumy.mozRequestFullScreen
...
(function(e) {
	var t = function(n) {
		...
		r.init = function() {
			...
			if (!r.displayType)
				r.displayType = t.FULL_SCREEN;
			if (r.displayType == t.RESPONSIVE)
				r.mustHaveHolderDiv_bl = true;
			...
			if (r.mustHaveHolderDiv_bl
					&& !FWDUtils.getChildById(r.props_obj.divHolderId)) {
				alert("FWDViewer holder div is not found, please make sure that the div exsists and the id is correct! "
						+ r.props_obj.divHolderId);
				return
			}
			if (r.displayType == t.FULL_SCREEN || r.displayType == t.LIGHTBOX) {
				...
				r.stageContainer = FWDUtils
						.getChildById(r.props_obj.divHolderId)
			}
			...
			this.backgroundColor_str = r.props_obj.backgroundColor
					|| "transparent";
			this.lightBoxBackgroundColor_str = r.props_obj.lightBoxBackgroundColor
					|| "transparent";
			...
			if (!FWDUtils.isReadyMethodCalled_bl)
		...
		r.setupViewer = function() {
			...
			r.setupInfo();
			r.setupData();
			if (FWDUtils.hasPointerEvent && FWDUtils.isMobile)
				e.addEventListener("contextmenu", r.preventContextMenu)
		};
		r.setupMainDo = function() {
			...
			if (!FWDUtils.isMobile || FWDUtils.isMobile
					&& FWDUtils.hasPointerEvent)
				r.main_do.setSelectable(false);
		...
		r.resizeHandler = function(e) {
			...
			if (r.viewportWidth == i.w && r.viewportHeight == i.h
					&& r.pageXOffset == n.x && r.pageYOffset == n.y && !e)
				return;
			r.viewportWidth = i.w;
			...
			if (r.displayType == t.LIGHTBOX && !r.isFullScreen_bl) {
				if (r.lightBoxWidth > i.w) {
					...
					r.finalLightBoxHeight = parseInt(r.lightBoxHeight
							* (i.w / r.lightBoxWidth))
				} else {
				...
				r.lightBox_do.mainLightBox_do
						.setX(parseInt((i.w - r.finalLightBoxWidth) / 2));
				r.lightBox_do.mainLightBox_do
						.setY(parseInt((i.h - r.finalLightBoxHeight) / 2));
				if (r.lightBox_do.closeButton_do
						&& !r.lightBox_do.closeButtonIsTweening_bl) {
					var s = parseInt((i.w + r.finalLightBoxWidth) / 2
							- r.lightBox_do.closeButton_do.totalWidth / 2);
					var o = parseInt((i.h - r.finalLightBoxHeight) / 2
							- r.lightBox_do.closeButton_do.totalHeight / 2);
					if (s + r.lightBox_do.closeButton_do.totalWidth > r.viewportWidth) {
						s = r.viewportWidth
								- r.lightBox_do.closeButton_do.totalWidth
					}
					if (o < 0) {
						o = 0
					}
			...
			if (r.controller_do)
				r.controller_do.resizeAndPosition();
			if (r.imageManager_do)
				r.imageManager_do.resizeAndPosition(false);
			if (r.navigator_do)
				r.navigator_do.resizeAndPosition();
			if (r.descriptionWindow_do && r.descriptionWindow_do.isShowed_bl)
				r.descriptionWindow_do.resizeAndPosition()
		};
		r.setupLightBox = function() {
			FWDLightBox.setPrototype();
			r.lightBox_do = new FWDLightBox(r, r.lightBoxBackgroundColor_str,
					r.backgroundColor_str, r.lightBoxBackgroundOpacity,
					r.lightBoxWidth, r.lightBoxHeight);
			r.lightBox_do
					.addListener(FWDLightBox.CLOSE, r.lightBoxCloseHandler);
			r.lightBox_do.addListener(FWDLightBox.HIDE_COMPLETE,
					r.lightBoxHideCompleteHandler);
		...
		r.lightBoxHideCompleteHandler = function() {
			if (r.dispatchEvent)
				r.dispatchEvent(t.CLOSE_LIGHTBOX);
			r.destroy()
		};
		r.setupContextMenu = function() {
			FWDContextMenu.setPrototype();
			r.customContextMenu = new FWDContextMenu(r, r.data);
			r.customContextMenu.addListener(FWDController.ROTATE,
					r.contextMenuRotateHandler);
			r.customContextMenu.addListener(FWDController.PAN,
					r.contextMenuPanHandler);
			r.customContextMenu.addListener(FWDController.GOTO_NEXT_IMAGE,
					r.contextMenuGoToNextImageHandler);
			r.customContextMenu.addListener(FWDController.GOTO_PREV_IMAGE,
					r.contextMenuGoToPrevImageHandler);
			r.customContextMenu.addListener(FWDController.ZOOM_IN,
					r.contextMenuZoomInHandler);
			r.customContextMenu.addListener(FWDController.ZOOM_OUT,
					r.contextMenuZoomOutHandler);
			r.customContextMenu.addListener(FWDController.START_SLIDE_SHOW,
					r.contextMenuStartSlideShowHandler);
			r.customContextMenu.addListener(FWDController.STOP_SLIDE_SHOW,
					r.contextMenuStopSlideShowHandler);
			r.customContextMenu.addListener(FWDController.SHOW_INFO,
					r.contextMenuShowInfoWindow);
			r.customContextMenu.addListener(FWDController.GO_FULL_SCREEN,
					r.controllerGoFullScreen);
			r.customContextMenu.addListener(FWDController.GO_NORMAL_SCREEN,
		...
		r.setupData = function() {
			...
			r.data.addListener(FWDData.LIGHBOX_CLOSE_BUTTON_LOADED,
					r.onLightboxCloseButtonLoadComplete);
			r.data.addListener(FWDData.PRELOADER_LOAD_DONE,
					r.onPreloaderLoadDone);
			r.data.addListener(FWDData.FIRST_IMAGE_LOAD_COMPLETE,
					r.firstImageLoadComplete);
			r.data.addListener(FWDData.LOAD_ERROR, r.dataLoadError);
			r.data
					.addListener(FWDData.SKIN_PROGRESS,
							r.dataSkinProgressHandler);
			r.data.addListener(FWDData.IMAGES_PROGRESS,
					r.dataImagesProgressHandler);
			r.data.addListener(FWDData.LOAD_DONE, r.dataLoadComplete);
			r.data.addListener(FWDData.IMAGE_LOADED, r.onImageLoad);
			r.data.addListener(FWDData.IMAGES_LOAD_COMPLETE,
					r.dataImagesLoadComplete)
		};
		r.onLightboxCloseButtonLoadComplete = function() {
			if (r.displayType == t.LIGHTBOX)
				r.lightBox_do.setupCloseButton(
						r.data.mainLightboxCloseButtonN_img,
						r.data.mainLightboxCloseButtonS_img)
		};
		r.firstImageLoadComplete = function() {
			if (r.data.showNavigator_bl)
				r.setupNavigator();
		...
		r.dataSkinProgressHandler = function(e) {
			r.preloader_do.update(e.percent, "Loading skin:"
					+ Math.round(e.percent * 100) + "%")
		};
		r.dataImagesProgressHandler = function(e) {
			r.preloader_do.update(e.percent, r.data.preloaderText_str
					+ Math.round(e.percent * 100) + "%")
		};
		...
		r.dataImagesLoadComplete = function() {
			...
			if (r.data.hideController_bl) {
				...
				if (r.navigator_do)
					r.navigator_do.setupHider(r.hider);
				r.startHiderWithDelayId_to = setTimeout(function() {
					r.hider.start()
				}, r.data.hideControllerDelay)
			}
			if (r.customContextMenu)
				r.customContextMenu.isActive_bl = true;
			if (r.navigator_do)
				r.navigator_do.activate();
			r.setupDescriptionWindow();
			r.setupRotationDumy();
			r.setupPanDumy();
			if (r.data.slideShowAutoPlay_bl)
				r.controller_do.startSlideshow();
			r.safeToControll_bl = true
		};
		r.setupPreloader = function() {
			FWDPreloader.setPrototype();
			r.preloader_do = new FWDPreloader(r, r.data.mainPreloader_img, 40,
					43, 60, r.data.preloaderFontColor_str,
					r.data.preloaderBackgroundColor_str);
			r.preloader_do.addListener(FWDPreloader.HIDE_COMPLETE,
					r.onPreloaderHideCompleteHandler);
			r.preloader_do.positionAndResize();
		...
		r.setupHider = function() {
			...
			r.hider = new FWDHider(r.data.isMobile_bl, r.main_do,
					r.data.hideControllerDelay)
		};
		r.setupController = function() {
			FWDController.setPrototype();
			r.controller_do = new FWDController(r.data, r);
			r.controller_do.addListener(FWDController.MOUSE_DOWN,
					r.controllerOnMouseDownHandler);
			r.controller_do.addListener(FWDController.CHANGE_NAVIGATION_STYLE,
					r.setImageViewerNavigationStyleHandler);
			r.controller_do.addListener(FWDController.GOTO_NEXT_OR_PREV_IMAGE,
					r.gotoNextImageHandler);
			r.controller_do.addListener(
					FWDController.GOTO_NEXT_OR_PREV_IMAGE_COMPLETE,
					r.gotoNextImageCompleteHandler);
			r.controller_do.addListener(FWDController.DISABLE_PAN_OR_MOVE,
					r.disablePanOrMoveHandler);
			r.controller_do.addListener(FWDController.ENABLE_PAN_OR_MOVE,
					r.enablePanOrMoveHandler);
			r.controller_do.addListener(FWDController.SCROLL_BAR_UPDATE,
					r.controllerScrollBarUpdateHandler);
			r.controller_do.addListener(FWDController.ZOOM_WITH_BUTTONS,
					r.controllerZoomHandler);
			r.controller_do.addListener(FWDController.START_SLIDE_SHOW,
					r.controllerStartSlideshowHandler);
			r.controller_do.addListener(FWDController.STOP_SLIDE_SHOW,
					r.controllerStopSlideshowHandler);
			r.controller_do.addListener(FWDController.SHOW_INFO,
					r.controllerShowInfoHandler);
			r.controller_do.addListener(FWDController.GO_FULL_SCREEN,
					r.controllerGoFullScreen);
			r.controller_do.addListener(FWDController.GO_NORMAL_SCREEN,
					r.controllerGoNormalSreen);
			if (r.controller_do)
				r.controller_do.resizeAndPosition();
		...
		r.gotoNextImageHandler = function(e) {
			if (!r.data.areAllImagesLoaded_bl)
				return;
		...
		r.controllerStartSlideshowHandler = function(e) {
			if (r.customContextMenu)
				r.customContextMenu.updateSlideShowButton(1)
		};
		r.controllerStopSlideshowHandler = function(e) {
			if (r.customContextMenu)
				r.customContextMenu.updateSlideShowButton(0)
		};
		r.controllerShowInfoHandler = function() {
			if (r.main_do.contains(r.descriptionWindow_do))
				return;
			r.main_do.addChild(r.descriptionWindow_do);
			r.descriptionWindow_do.hide(false, true);
			r.descriptionWindow_do.show(r.data.infoText_str)
		...
		r.controllerGoFullScreen = function() {
			...
			if (r.customContextMenu)
				r.customContextMenu.updateFullScreenButton(1);
			if (document.addEventListener) {
		...
		r.controllerGoNormalSreen = function() {
			...
			if (r.customContextMenu)
				r.customContextMenu.updateFullScreenButton(0);
		...
		r.setupImageManager = function(e) {
			...
			r.imageManager_do.addListener(
					FWDImageManager.LARGE_IMAGE_LOAD_ERROR,
					r.imageManagerLoadError);
			r.imageManager_do.addListener(FWDImageManager.SCROLL_BAR_UPDATE,
					r.imageManagerScrollBarUpdate);
			r.imageManager_do.addListener(FWDImageManager.PAN_START,
					r.imageManagerPanStartHandler);
			r.imageManager_do.addListener(FWDImageManager.ROTATE_START,
					r.imageManagerRotateStartHandler);
			r.imageManager_do.addListener(FWDImageManager.ROTATE_UPDATE,
					r.imageManagerRotateUpdateHandler);
			r.imageManager_do.addListener(FWDImageManager.SHOW_NAVIGATOR,
					r.imageManagerShowNavigatorHandler);
			r.imageManager_do.addListener(FWDImageManager.HIDE_NAVIGATOR,
					r.imageManagerHideNavigatorHandler);
			r.imageManager_do.addListener(FWDImageManager.UPDATE_NAVIGATOR,
					r.imageManagerUpdateNavigatorHandler);
			r.imageManager_do.addListener(FWDImageManager.SHOW_INFO,
					r.imageManagerShowInfoHandler);
		...
		r.imageManagerRotateUpdateHandler = function(e) {
			if (r.navigator_do)
				r.navigator_do.updateImage(e.id);
			if (r.main_do.contains(r.info_do))
				r.main_do.removeChild(r.info_do)
		};
		...
		r.imageManagerUpdateNavigatorHandler = function(e) {
			r.navigator_do.update(e.percentX, e.percentY, e.percentWidth,
					e.percentHeight, e.animate)
		};
		...
		r.setupNavigator = function() {
			...
			r.navigator_do.addListener(FWDNavigator.MOUSE_DOWN,
					r.navigatorOnMouseDownHandler);
			r.navigator_do.addListener(FWDNavigator.PAN_START,
		...
		r.setupDescriptionWindow = function() {
			...
			r.descriptionWindow_do.addListener(FWDDescriptionWindow.SHOW_START,
					r.descWindowShowStartHandler);
			r.descriptionWindow_do.addListener(
					FWDDescriptionWindow.HIDE_COMPLETE,
					r.descWindowHideComplteHandler)
		};
		r.descWindowShowStartHandler = function() {
			if (r.customContextMenu)
				r.customContextMenu.disable()
		};
		r.descWindowHideComplteHandler = function() {
			if (r.customContextMenu)
				r.customContextMenu.enable();
		...
		this.setupRotationDumy = function() {
			...
			if (FWDUtils.isIE)
				r.rotateDumy_sdo.getStyle().background = "url('dumy')";
			r.rotateDumy_sdo.getStyle().cursor = "url("
					+ r.data.handGrabRotatePath_str + "), default";
		...
		this.setupPanDumy = function() {
			...
			if (FWDUtils.isIE)
				r.panDumy_sdo.getStyle().background = "url('dumy')";
			r.panDumy_sdo.getStyle().cursor = "url(" + r.data.handGrabPath_str
					+ "), default";
		...
		this.setupDisableMarkersDumy = function() {
			...
			if (FWDUtils.isIE)
				r.markersDumy_sdo.getStyle().background = "url('dumy')";
		...
		this.pan = function() {
			if (r.safeToControll_bl)
				r.controller_do.pan()
		};
		this.rotate = function() {
			if (r.safeToControll_bl)
				r.controller_do.rotate()
		};
		this.rotateLeft = function() {
			if (r.safeToControll_bl)
				r.controller_do.prevButtonStartHandler()
		};
		this.rotateRight = function() {
			if (r.safeToControll_bl)
				r.controller_do.nextButtonStartHandler()
		};
		this.zoomOut = function() {
			if (r.safeToControll_bl)
				r.controller_do.zoomOutStartHandler()
		};
		this.zoomIn = function() {
			if (r.safeToControll_bl)
				r.controller_do.zoomInStartHandler()
		};
		this.play = function() {
			if (r.safeToControll_bl)
				r.controller_do.startSlideshow()
		...
		this.info = function() {
			if (r.safeToControll_bl)
				r.controller_do.infoButtonStartHandler()
		};
		...
		r.destroy = function() {
			...
			if (r.data)
				r.data.destroy();
			if (r.lightBox_do)
				r.lightBox_do.destroy();
			if (r.preloader_do)
				r.preloader_do.destroy();
			if (r.customContextMenu)
				r.customContextMenu.destroy();
			if (r.info_do)
				r.info_do.destroy();
			if (r.imageManager_do) {
			...
			if (r.controller_do)
				r.controller_do.destroy();
			if (r.navigator_do)
				r.navigator_do.destroy();
			if (r.hider)
				r.hider.destroy();
			if (r.descriptionWindow_do)
				r.descriptionWindow_do.destroy();
			if (r.rotateDumy_sdo)
				r.rotateDumy_sdo.destroy();
			if (r.markersDumy_sdo)
				r.markersDumy_sdo.destroy();
			if (r.panDumy_sdo)
				r.panDumy_sdo.destroy();
			try {
				...
				function(e) {
					var t = function(e, n, r, i, s, o, u, a, f, l, c) {
						...
						h.setupMainContainers = function() {
							...
							if (FWDUtils.isIEAndLessThen9 || FWDUtils.isSafari) {
								h.text_sdo
										.setY(parseInt((h.totalHeight - 8) / 2) - 2)
							} else {
								h.text_sdo
										.setY(parseInt((h.totalHeight - 8) / 2) - 1)
							}
							h.addChild(h.text_sdo);
							h.pointer_img = new Image;
							if (h.pointerPosition_str == FWDController.POSITION_BOTTOM) {
							...
							setTimeout(
									function() {
										if (h == null)
											return;
										h.middle_sdo
												.setWidth(h.text_sdo.screen.offsetWidth);
										h.right_sdo
												.setX(h.text_sdo.screen.offsetWidth
														+ h.marginWidth);
										h.totalWidth = h.marginWidth * 2
												+ h.text_sdo.screen.offsetWidth;
										h.positionPointer(0)
						...
						h.positionPointer = function(e) {
							...
							if (!e)
								e = 0;
							t = parseInt((h.totalWidth - h.pointerWidth) / 2)
									+ e;
							if (h.pointerPosition_str == FWDController.POSITION_BOTTOM) {
								n = h.totalHeight - 1
							} else {
			...
			if (r.isScrollBarActive_bl) {
				...
				if (r.minWidth > r.stageWidth) {
					...
					if (r.minWidth < 320)
						r.minWidth = 320;
					s = r.buttonWidth * t;
					n = (r.minWidth - r.startSpaceBetweenButtons * 2 - s)
							/ (t - 1)
				}
				r.curWidth = r.minWidth;
				for (var h = 0; h < t + 2; h++) {
		...
		r.positionAndSetLabelScrollBarHandler = function() {
			...
			setTimeout(
					function() {
						...
						t = parseInt(r.scrollBarHandler_do.getX()
								+ r.scrollBar_do.getX()
								+ (r.scrollBarHandlerWidth - r.scrollBarHandlerToolTip_do.totalWidth)
								/ 2);
						if (r.controllerPosition_str == e.POSITION_BOTTOM) {
							n = -r.scrollBarHandlerToolTip_do.totalHeight
									- r.scrollBarHandlerToolTipOffsetY
				...
				setTimeout(
						function() {
							...
							if (i.stageHeight < 120)
								i.mainContentFinalY = 0;
							i.scrollBarHandlerHeight = Math.min(
									i.scrollBarHeight - 20, i.stageHeight
											/ i.contentHolderHeight
											* (i.scrollBarHeight - 20));
							if (i.scrollBarHandlerHeight > 500) {
								i.scrollBarHandlerHeight = 500
...
(function() {
	var e = function(t, n) {
		...
		this.startToSwipe = function() {
			...
			r.swipeDirection_str = r.swipeDragDist < 0 ? "left" : "right";
			r.swipeDragDist = Math.abs(r.swipeDragDist
					/ (20 * r.dragAndSpinSpeed));
			r.dragAndSpinId_int = setInterval(r.swipeTweenUpdate, 16)
		};
		this.swipeTweenUpdate = function() {
			var e = 0;
			...
			r.showMarkerToolTipId_to = setTimeout(
					function() {
						if (!r.markersToolTip_do.isShowed_bl)
							return;
						n = parseInt(e.finalX
								+ (e.width - r.markersToolTip_do.totalWidth)
								/ 2);
						i = e.finalY - r.markersToolTip_do.totalHeight
								- r.markerToolTipOffsetY;
						if (i < 0) {
						...
						i.render = function(e, t, n) {
							...
							if (e >= r) {
								...
								if (this._easeType) {
									...
									this.ratio = this._ease.getRatio(this._time
											/ this._duration)
								}
							}
							if (i === this._time && !n) {
						...
						u.insertMultiple = function(e, t, n, i) {
							...
							for (s = 0; s < a; s++) {
								...
								if (typeof o === "string"
									...
									u = o._startTime + o.totalDuration()
											/ o._timeScale
								} else if (n === "start") {
									o._startTime -= o.delay()
								}
							...
							if (e >= r) {
								...
								if (!this._locked) {
									...
									if (this._repeat !== 0) {
										...
										this._cycle = this._totalTime / g >> 0;
										if (this._cycle !== 0)
											if (this._cycle === this._totalTime
													/ g) {
												this._cycle--
											}
										this._time = this._totalTime
